...
#!!! did Jenna end up getting a phone before she left? She explicitly doesn't have one 1.5 years ago during Route 65
#!!! it's probably more useful to this story for her to have magically acquired one, as her family tries to call her later during this short story
...
#! starting two sentences in a row with "And" is too noticeable
"While people walking around with shifty-looking bags at night isn't an uncommon sight in Echo, I stick to the shadows regardless."
...
#!!! Reduces repetition of "his", and it's not technically Chase's car anyway
"Chase is leaning against the car, his face illuminated by the light of his phone."
...
#!!!! it's weird for Jenna to think that cold temperatures can cause you to "catch a cold", seeing as she's really into science and biology?
...
#!!! Maybe? otherwise this sentence could use some general restructuring for readability.
...
$ pan("music", -0.35)
play music "emo.ogg"
"One of Chase and Leo's songs, or as Flynn likes to call them, {i}\"emo garbage with shitty lyrics\"{/i}, starts playing."
...
jas "\"Aw, did I offend you, {i}chula{/i}?\""
...
m "\"So what made you do the thing you're doing {i}right now{/i}?\""
...
#!!! probably change "Carl's" -> "Carl". I understand the original intent, but it's difficult to read without doing a double-take
m "\"I mean, Leo and I aren't exactly Echo's darlings, but Carl... he's harmless.\""
...
"My parents always conveniently left out the part where they were gay lovers, of course, but a trip to the library cleared that one up for me."
#!!! "not that they cared" about what? they didn't care that she went to the library, or didn't care that James+John were gay?
#!!! if they didn't care that James+John were gay, why hide it from Jenna? Not sure if I'm missing something.
"Not that they cared."
...
jas "\"Do your parents not like that you're with Leo?\""
...
#!! ". But" could be ", but" or other restructuring
...
#!!! the repetition of "door" is pretty meh as a closer. Consider reworking the first instance of "door" out of the sentence
