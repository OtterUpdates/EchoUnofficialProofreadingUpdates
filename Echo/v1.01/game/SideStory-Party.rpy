...
"A brief hope, a glimmer of salvation bubbles to the surface when I feel something metal and pointy."
...
c "\"So, this Vincent guy. Is it a date, or...?\""
"I roll my eyes."
...
c "\"Your mom made me promise to look after you, man.\""
"He slams the bottle down a bit too hard. Soda erupts from the bottle and stains his pants."
show Carl Annoyed with dis
c "\"Well, fuck.\""
show Carl Neutral with dis
"I laugh."
#!! "Sounds" -> "Seems"? Not really any audio cues that this could be referring to
m "\"Seems like you need more help than I do.\""
show Carl with dis
...
#!! The next two lines don't really agree on singular/plural. Either change "It's from a few months" -> "They're from a few months", or "form on them" -> "form on it" in the next line
"I eye one of the magazines sitting on the table. It's from a few months back, before we even got here."
"A layer of dust is starting to form on it."
...
#! maybe?
"He pulls his beanie down to the point that it's almost covering his eyes. I can see him nodding under there. I think."
...
"There's a couple of cars in the parking lot in front of the building already. Mine looks out of place next to all the newer models."
...
"I call out to her, but it doesn't seem like she can hear me. Just when I'm about to try again, Vince tugs me into his room."
...
#!! probably "Think he's in" -> "I think he's in". The writing generally never uses that sort of slang.
"I've seen the lion around campus before, but I don't know his name, just his face. I think he's in Carl's class."
m "\"Like, drugs?\""
...
#!!! 4th line wrap that intersects the UI elements here. I broke it out into a new line
