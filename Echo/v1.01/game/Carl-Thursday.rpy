...
"Once I get to the crawl space I do an awkward, half-run to the flood lamp that probably would have made Carl laugh his ass off."
scene bg crawlspace
play sound "switch.ogg"
play loop "floodlight.ogg"
play music "neutral.ogg" fadein 3.0
"The crawl space really is fucking creepy."
"I imagine Carl sleepwalking down here (which I'm pretty sure is what happened last night) then waking up alone in the dark."
...
"I still don't know if what I saw was real, or if it was some kind of hypnagogic hallucination that my mind always seems so keen to throw at me."
"I scan the tarp, its white and clean surface free of any insects, as far as I can tell."
...
#!!! Is this sentence implying that chase didn't have sleep paralysis before he went to Pueblo? He mentions that he gets sleep paralysis in Route 65
...
"I stare at them for a second, remembering that two days ago the tubs had been turned to have their sides facing the entrance to the crawl space."
...
"One divider indicates \"James Hendricks\" while another marks \"Emma Hendricks\", who I assume is James's wife."
...
stop music fadeout 3.0
"I start with that, my fingers shaking a bit with excitement as I start poring over Trisha's meticulous timeline, using my phone to take notes."
...
"Despite this, they managed to make a living with James's father becoming a plumber, a profession that mainly dealt with lead."
"His father, Martin, was abusive, even more so than was acceptable for the time, and James suffered greatly for it."
"The mysterious death of his five-year-old sister, Martha, led many of the townspeople to suspect murder on the father's part—"
...
"John was a Native desert fox, and would go on to become James's business partner."
#!!!! I assume James is the one with prejudice, not John?
"This comes as a bit of a surprise due to James's many recorded instances of prejudice against the Natives."
...
"Apparently Carl's game is so good that he hasn't even bothered to come down and check on me."
...
#!!!! There's no textual accompaniment for the knocking, and there probably should be
...
"And that's when I notice something: at the very bottom of the tub a plastic baggie has been opened with its contents spilled out."
"I set down the binder that I had been about to put away and reach in, sifting through the spilled papers."
...
#! Not sure what the least jarring way to represent this in the sentence is
...
"He sits up and rubs at his face, snorting again as he breathes deeply."
...
"He finally does look at me, then, his expression kind of sad."
m "\"What's wrong?\""
...
"Finally, he lowers the phone from his ear, then stares at the screen for a while."
m "\"She hang up?\""
...
c "\"Yeah...\""
"Carl looks out his window, so I can't really gauge the mood he's in."
...
#!!! Capitalize "Subway" or drop the brand name, e.g. "sub sandwich"
...
"Raven picks up on my sarcastic tone right away, but it doesn't seem to faze him."
...
"Carl crumples up a straw wrapper and flicks it off Raven's bluish-looking nose, to which he simply smiles."
"Carl stands up."
...
scene bg black
with transition_fade
#!!! This 5 second pause is weird. Maybe take it out and also the next 'scene bg black with fade'?
...
"Into darkness—"
"Furry legs crawl all over my body and pin pricks pierce every inch of my flesh."
