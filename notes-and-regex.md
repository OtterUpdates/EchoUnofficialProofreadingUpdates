...
# Misc unsorted/unfinished stuff:
  ...
  * more contractions - everyone in Echo speaks in casual and slang, and when they don't use contractions it's jarring as a result. If not using a contraction, there's opportunity to italicize one of the parts to show that it's intentionally broken out for emphasis