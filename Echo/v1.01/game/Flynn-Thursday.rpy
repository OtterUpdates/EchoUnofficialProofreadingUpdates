...
"I can hear some clinking around in the kitchen, then the murmur of some voices."
...
"I catch a few words from Leo that make my ears perk."
...
menu:
    "Follow them.":
        ...
        #!! "down to the hall" -> "down the hall"?
        "You follow the voices down the hall, into the kitchen."
...
"I shrug."
m "\"Something like that. I'm not very good at psych stuff.\""
...
"Carl shrugs."
c "\"Buncha stuff. He wanted to buy you something from the Reservation, but thought it might be too weird.\""
...
#!! "control" -> "controller"?
"He twists the controller this way and that, bumping into my shoulder each time."
...
#!! remove one of the "shifts", i.e. "His bloodshot gaze shifts" or "He shifts his bloodshot gaze"
"The ram blinks slowly, his maw starting to hang agape. He shifts his bloodshot gaze toward my torso."
...
menu:
    "Reassure him.":
        $ carl_car = "help"
        #!! sobered -> sober? sobered seems okay, but dictionaries don't list it as an adjective, and sober is the more common way to say this
        m "\"Carl, man.. you're acting pretty sober right now, and you don't smell like weed too fiercely - at least to my otter senses.\""
    ...
    "Let him stay in the car.":
        ...
        c "\"'Cept for the aliens that crashed out here in the '40s. That's still classified, Agent Hunter.\""
        ...
        "Eventually Carl started getting really into superhero stuff, and tried to segue our adventures into the SuperWolf universe."
        ...
        m "\"Er, hey.\""
        #!!! "going" -> "go"/"get"/etc?
        "He exhales, his demeanor shifting. His raised shoulders go more lax and his tail settles on the musty, carpeted floor."
        f "\"What?\""
        ...
        f "\"So you don't have a parcel number or date or anything? You just want to, what, 'browse'?\""
        ...
        f "\"I can set you up in the mailroom with the microfiche and a computer for the time being.\""
        ...
        "I pause, then quickly shake my head."
        m "\"No, sorry.\""
        show Mayor with dis
        ...
        "Honestly, I can't imagine the sheer amount of sugarcoating I'd need to muster to create a {i}positive{/i} report about this place."
        f "\"Fill this out.\""
        ...
        ma "\"Yes.\""
        f "\"Alright then.\""
        #!! "computer's speakers" could be changed to "computer speakers" or something to remove the double "'s"
        "He huffs some idly. The podcasters on Flynn's computer speakers are going into detail about creating complex fish nets and trappings."
        ...
        f "\"We've got physical records - the real old ones - stored in the mailroom. Though, I wouldn't say the shit there's very 'browsable'.\""
        ...
        "I try to think up something to say to make this right - to make this not as awkward as it seems to be getting."
        ...
        "Fuck."
        #!!! This "hide" doesn't seem to do anything useful. It does make the text pause for a second though
        # hide Flynn with dissolve
        stop background fadeout 3.0
...
menu:
    ...
    "{i}I hope the AC breaks in there.{/i}":
        ...
        f "\"Oh, he's fucking stoned off his rocker, ain't he?\""
        "Flynn is squinting in the window at the ram, who seems to be chuckling to himself."
        m "\"He ate too much of an edible this morning, apparently.\""
        "Flynn looks to me, then back to Carl."
        f "\"Probably for the best he's staying in the car, then. Come on.\""
...
"He points to a cream-colored computer that must be from around the early 2000s by the look of the make, dust visible on top of the tower."
...
m "\"I don't think she has many ties to her tribe.\""
show Flynnalt Annoyed with dis
...
#!! they suddenly were -> they were suddenly?
"He looks down at some papers in his hand, as if they were suddenly very interesting."
...
f "\"TJ cried every day, no matter what. He could see a dead fly on a windowsill and start bawling.\""
f "\"And you all would drop everything and come rushing to his aid, scorning the shit out of anybody who didn't.\""
f "\"We couldn't make jokes, we couldn't tease each other, we couldn't roughhouse, and we couldn't even fucking swear, without TJ getting upset.\""
...
"Flynn uncrosses his arms, staring some out the sole window of the cramped mailroom."
...
"As I hear the increasingly quiet rasp of Flynn's voice in the other room, I realize he's probably too busy to hold my hand regarding where to look."
...
menu:
    "The mine." if documents_pick_mine == False:
        ...
        "Huh."
        "That's a hell of a lot more verdant than it is these days. Might have to do with the damming they did up north in the '50s."
        ...
        #! probably?
        "There's even a reference to a large placard installed into the side of the rock face outside, but I don't remember ever seeing that."
        ...
        "-occurred with some frequency. Many miners were crippled from blows to the paws or arms, and then once fired, were unable to support their families."
        "This led to several notable starvation incidents within the town."
        "The lawsuit documents also include a reference to a brief 'riot' in 1915, where a grisly murder took place within the mines itself."
    ...
    "City hall." if documents_pick_cityhall == False:
        ...
        "Whoa.."
        #!! "that is" -> "that's"?
        "If that's really the date of origin in the top-right corner, this photo of these guys was taken at city hall 100 years ago."
        "I look back down to the folder, finding a caption note for the image:"
        #!!! "at town meeting" -> "at a town meeting"? hard to tell if meeting is a verb or noun
        ...
        "\"Adler\".. I just realized now that's Janice's last name."
    ...
    "Carl's mansion." if documents_pick_mansion == False:
        ...
        "I guess life in the early 20th century will do that to you."
        ...
        #!!! poison(ous) -> venom(ous)? This sort of implies that James ate a spider otherwise. "Poison" in this line may be more natural than "venom" as a cause of death?
        "The cause of death is listed as \"\poison/infection (theraphosidae - tarantula)\"."
        #!!! poison(ous) -> venom(ous)? This sort of implies that James ate a spider otherwise
        "This is pretty unsettling. I didn't think tarantulas were venomous."
...
ma "\"Did you now?\""
"She steps in the room and picks up a folder from the edge of the counter. I recognize it as the one for the abandoned mines."
...
"The way she phrases that makes me reconsider a hasty response."
...
"Flynn steps past us without much acknowledgment, moving to the kitchen beside Daxton."
...
#!!! "he's" -> "Carl's" otherwise it's not clear who is texting since Daxton was the last person mentioned
"Looking over, it looks like Carl's texting."
...
"Carl blinks."
"I hear Flynn grunt derisively, the clicking of the stovetop audible as he turns the nozzle for the gas."
...
"Daxton raises a brow, nodding in acknowledgment."
...
m "\"What?\""
"Flynn flicks the stovetop off, his eyes lulled and his brow-ridge furrowed. Daxton passes him with the tray of rye-and-havarti, sliding it in the oven."
...
"The salamander looks standoffish now, his arms crossed. My question seems to have been ignored."
f "\"Might be.\""
...
c "\"Sort of? I don't really watch it myself. It's that space exploration starship show from the '60s with the sexy aliens?\""
...
da "\"Chase? Flynn?\""
"I sigh. Usually TV is a bit too passive for me when I'm trying to get my mind off stuff. Most often, I turn to video games, instead."
...
show Daxton Annoyed with dis
"Daxton looks as if a bad taste just settled on his palate."
...
f "\"But it wasn't for you when you were a kid, or the titdirts who watched it back in the '60s.\""
...
show flynnlivingroom3 with dissolve
"Carl gives me a little nudge, and we follow suit, beers in grasp."
...
"Daxton looks a bit defensive, leaning forward on the edge of his seat - his plump tail wrapped around the armrest."
...
f "\"I'm heading out.\""
"He pushes himself up from the couch, unruffling his shirt before meandering over toward a bowl in the kitchen to get his truck keys."
m "\"Wait, what?\""
c "\"Aw, c'mon, slithead!\""
...
#!! "he's leaving me not much choice" -> "he's not leaving me much choice"?
"..I know I shouldn't snoop through his phone, but if he wants to act all mysterious and dismissive, he's not leaving me much choice."
...
"Which is surprising. We usually get less than an inch of rain this time of year."
play sound "phonebuzz.ogg"
$ renpy.pause(1, hard=False)
"Another text?"
play sound "rustle.ogg"
...
"I angle the rearview mirror down toward me."
...
show Daxton Annoyed with dis
#!! maybe drop the comma between "oh" and "god"?
da "\"Oh, god, Carl.\""
...
c "\"Chase..\""
m "\"Hm?\""
"I loosen my grip on the wheel some, peering in the rearview mirror and catching the glint of Carl's green eyes looking back at me."
...
da "\"I surround myself with TV, books, and video games and the fact that I'm alone in the middle of the desert doesn't even affect me.\""
m "\"You've got Flynn for company, don't you?\""
da "\"We keep to our separate sides of the house usually. Sometimes almost a whole week goes by without me actually seeing him.\""
...
m "\"Ass.\""
"Daxton slowly relents, keeping a close eye on Carl as he gives him his phone."
...
c "\"I bet gun skins on ranked matches online sometimes. That place is mainly for really old people, packed in their RVs.\""
...
#!! "he is" -> "he's"?
"Carl seems like he's about to say something, but quiets as we all see our 'destination'."
da "\"Oh, jeez..\""
play sound "engineoff.mp3"
stop music fadeout 3.0
stop background fadeout 3.0
...
"There are about a half-dozen cars parked behind the building. Flynn's truck is the only one out front."
...
c "\"Oh no, man! Lieutenant Daxton beamed out too early. His particles are destabilizing!\""
...
"He leans back in his seat, pulling up his phone. The illuminating blue glow of the screen replaces the faint orange of the street light."
...
"I see him grinning in the rearview mirror."
...
"He doesn't have scales like Flynn, so he's just this rubbery black-color that blends into the shadows, as speciesist as that sounds."
...
"The walls are mainly decorated with faded, 1950s beer adverts, and a mounted CRT monitor near the entrance looks to be streaming an old cricket match."
#!! probably put an emdash or semicolon in here
"I don't see any bartenders or waiters; nobody is behind the bar."
da "\"Huh...\""
#!! or change both to hyphens?
...
#!!! Salamanders do have better night vision. Daxton also explicitly says he has good night vision ("better eyes for night stuff") later in the route
...
#!! "there is" -> "there's"
"I realize that there's a much smaller person behind them: a fennec girl with big, lengthy headfur that goes down to her shoulders."
"One of them - the one in the teal polo with a beer gut - sets out a rack of pool balls on the table."
"The other horse with a red polo and graying muzzle fur speaks up, shaking his head and pointing toward the balls in the triangle."
...
"He holds up the flats of his rubbery palms."
...
"Ryan pulls out his wallet, withdrawing a few bills and handing them to the fox."
...
"They look at each other, saying nothing. Flynn parts his lips slightly, and the fox pushes their face against his, maws meeting in a deep kiss."
...
"Ryan withdraws a small plastic baggie with about six tiny, white spheroid dots inside."
"They kind of look like that expensive, pebble ice-cream they sell at theme parks."
...
"He opens the little baggie, placing one of the pebbles on the eager fennec's tongue, then his own."
"The German shepherd rises up to his feet. He's large, about as tall as Leo."
"He extends out the baggie to Daxton and I."
"Before we can respond, Flynn interjects - swiping the baggie and closing it before handing it back to Ryan."
f "\"Yeah, nah, fucker.\""
...
"Ryan quickly deposits the baggie back into his trousers, pushing his chair in. Flynn stands up as well."
...
show Daxton Surprised with dis
da "\"I-.. oh my God.\""
"Daxton looks like he's been slapped, his tail coiling inward. Mike just chuckles in a bassy rumble."
...
da "\"Never straightforward with him, is it?\""
...
"Silhouettes of people dance in a limp-daze. The flickering lights make the shapes look like rag dolls flailing in stop-motion."
...
menu:
    ...
    "{i}Play it cool.{/i}":
        "I dip my paws into my pockets, putting on the most lax posture I can manage."
        ...
        f "\"Ryan showed me it a long while ago. It was so fucking gross. There were like four old-ass beavers with balls down to their knees ruttin' in the corner.\""
        m "\"And you came {i}back{/i}?\""
        f "\"'ey, this ain't fuckin' ritzy-ass Pueblo where there's 12 gay bars within 10 miles, equipped with cheap beer and blow job dispensers.\""
        f "\"You get bored.\""
        m "\"..and lonely?\""
        ...
        m "\"Uh-huh, you sure it wasn't one of the cucumbers?\""
        ...
        menu:
            ...
            "{i}Let's do this.{/i}":
                ...
                "He tugs me along to a small corner of the room with little lighting. A red, patchwork curtain hangs from the ceiling."
                ...
                #!!! "in clustered grounds"? Is this supposed to be "groups"?
                "I do the same, trying not to imagine the leering eyes in clustered groups around us."
                ...
                "An older man at the other end of the room yells something in another language and someone turns the volume up on the TVs."
                ...
                "Flynn's gray muzzle parts to a brief grin."
                ...
                "With Leo, I'd always end up having to finger him for quite a while before being able to top him."
                ...
                "I prop myself up on the balls of my feet now, angling downward as I thrust since Flynn seems to be most sensitive there by the way he's moaning."
                "I look up, about to kiss Flynn again, when I notice a pair of dark, furred thighs next to his head."
                ...
                "Really hot."
                #! probably?
                "I manage a few more pumps before I feel myself begin to cum."
                ...
                "Someone is talking to me in a foreign language now. They laugh once, and a paw slaps my ass."
                "I wince. Things start to seem different around me, like the smoky haze itself had become much less of a veil of my surroundings."
            ...
            "{i}This is too weird.{/i}":
                ...
                #!!! Not sure what the structure is supposed to be here. "then something warm" implies that Chase is hearing something warm
                "I hear the sound of a jingling belt beside me and unzipping, then feel something warm against my waist. I'm not paying attention to that, though."
                ...
                f "\"What?\""
                m "\"I can't, man.\""
                "I turn, pulling from Flynn's side and heading toward the door."
    ...
    "{i}This is fucked.{/i}":
        ...
        "I turn, quickly trying to figure out the weird twisty door handle to get out of here."
        ...
        f "\"Ryan showed me it a long while ago. It was so fucking gross. There were like four old-ass beavers with balls down to their knees ruttin' in the corner.\""
        m "\"And you came {i}back{/i}?\""
        f "\"Oy, this ain't fuckin' ritzy-ass Pueblo where there's 12 gay bars within 10 miles, equipped with cheap beer and blow job dispensers.\""
        f "\"You get bored.\""
        m "\"..and lonely?\""
        "Flynn grunts, and I feel his weight on my shoulder intensify some."
        m "\"So Ryan's your.. {i}friend{/i}?\""
        ...
        "For some reason, I'm a bit shaky - like it's cold or something."
        ...
        f "\"So, tell me what you think you want, and we'll go from there. A'ight, titdirt?\""
        ...
        #!! "just" -> "jut"? Not clear what's intended here
        "I jut my arm out, pointing to the dilapidated, red building beside us."
        ...
        f "\"Remember how that just stopped when you two started learnin' your dicks could go in each other's asses?\""
        ...
        "As I shut my eyes, I feel a sting within them."
...
window show
"I bring the tripod back over my shoulder, wincing some as the metal pushes against my collarbone."
play background "reststop.ogg" fadein 2.0
...
""
#!! consider changing "cooking ourselves" -> "cooking for ourselves" to make it more clear the kids aren't literally grilling themselves
"When we were kids, sometimes my dad would let us roll our little charcoal grill up there and try cooking for ourselves."
"My dad always said it was to keep a wide buffer between us and the house so we didn't accidentally burn the place down."
"After Flynn set a bush on fire in our backyard during Labor Day, I kind of understood the sentiment."
"I exhale, shoving my phone back in my pocket."
call text_end from _call_text_end_30
#! probably
"Interesting that Leo decided to schedule it while Flynn is still working."
...
"He claimed I had no aptitude for work - first placing the blame on me playing too many video games, then Leo..."
...
l "\"We're gonna grill up these fancy pepper jack hot dogs we got in Payton, and some applewood smoked bacon.\""
m "\"That sounds good.\""
...
"She crosses her arms over her tank-topped chest, looking down, then back up again."
j "\"It's okay.\""
...
j "\"Yes, I know, it's a spice-overload, but it was to appease Leo's iron palate.\""
...
l "\"Chase, can y-\""
"Past the sizzling of the grill, the clops of hooves on dirt become audible."
...
"Meanwhile, TJ seems to bolt up, offering a paw to the tall salamander."
...
c "\"Everything, dude.\""
m "\"Coalville.. isn't that the place with the lampposts that have little cowboy hats on top of them?\""
...
#!! "the" should probably be capitalized here?
...
da "\"Nah, not really. He was a major speciesist and hated Jews.\""
...
menu:
    ...
    "{i}Pop Summer Jams Club/Beach Playlist{/i}":
        ...
        #!!! Jenna says this is explicitly her type of music, so this copy-pasted line doesn't really work here
...
menu:
    "Dance with Leo":
        ...
        "My mind reels back to Leo's confrontations with Flynn these past few days, his violent behavior."
    ...
    "Dance with TJ and Jenna":
        ...
        j "\"Sure, Chase.\""
        "Jenna's swaying her hips, arms above her head, with her paws swirling in slow circles."
...
menu:
    ...
    "\"Sure.\"" :
        ...
        #!! "days" -> "day"?
        da "\"Dreams are the sorting and categorizing of the happenings of the day by the subconscious of the mind.\""
        ...
        da "\"You were crumpling and dissolving every time I touched you. Your fur turned gray and speckled, and your face didn't look like you anymore.\""
        ...
        da "\"It became nighttime and then you said you were sorry. I asked you why you were sorry and you hugged me.\""
        da "\"It was..\""
        ...
        m "\"What?\""
        da "\"He had just gotten home from the bar. Didn't say two words to me and beelined to his room.\""
        ...
        "I try to put on a nonchalant tone."
        ...
        #!! "insomniatic" isn't a word, but it's passable here as chase making up a word on the fly
        m "\"I try not to think about it too much, otherwise I get all insomniatic.\""
        da "\"Man, that sucks.\""
        m "\"They all know about it.\""
        "I gesture toward the backyard. I can still faintly hear TJ chatting excitedly about something, with Jenna chiming in every now and then."
        ...
        play sound "heavyfootsteps.ogg"
        hide Daxton with easeoutright
        "With that, he turns and heads out toward the backyard."
    ...
    "\"Actually, I wanted to talk to Leo for a bit.\"" :
        ...
        m "\"I was too young to understand the speciesist implications of that idea.\""
        ...
        l "\"You show up for the first time in years and it's like you don't want nothing to do with me.\""
        ...
        menu:
            ...
            "Hug him.":
                ...
                "Leo says nothing."
                "The minutes pass. I can hear TJ talking excitedly about something out in the backyard, with Jenna chiming in occasionally."
...
m "\"Not, like, deathly.\""
"I cross my arms over my chest, tugging some at the fabric of my shirt."
j "\"Right, of course.\""
"TJ snickers some."
...
"I scramble back, kicking at it with as much force as I can muster."
scene bg chasehouse
show TJ Surprised at left
show Jenna Smiling at right
with vpunch
...
"I don't see any sign of judgment on his face, either. Just genuine curiosity."
...
j "\"Very noncommittal, and giving himself something that he can hold against you, if need be, to protect himself from having any semblance of vulnerability.\""
...
"I take a few packets of the candy-egg oatmeal that we've got about twenty of and empty them into one of the complimentary styrofoam bowls on the table."
...
"I remember watching shows like this with my mom as a kid, and they were always about hair metal bands from the '80s and '90s."
...
#!!! maybe change "from home movies, machinima, to" -> "from home movies and machinima to"?
"There's nearly a gig of videos on my old laptop ranging from home movies and machinima to class projects I did with the group."
...
t "\"No! He was just shouting. I heard a few words here and there, but never like any full sentences or anything.\""
...
#!!! "then that" is awkward. I'm also not following what Chase is connecting this sentence to prior - no businesses means people are weird, including his friends?
...
t "\"And I don't mean like, ugly. I mean she was kinda grimy and smelled like raw meat.\""
...
stop music fadeout 5.0
m "\"...\""
#!!! I'm not sure I remember this happening?
...
m "\"Whoa...\""
#! ", as well," is a little awkward. The other copy-paste of this section uses ", too," which I think reads better
...
#!! Chase didn't say he was upset when he saw the thing, did he?
...
"I feel my breathing start to get shaky."
...
"That's fine, too."
"I place my thumbs beneath the bottom of his mask and pull up."
stop loop
...
"Some kind of bird falls from the sky. I think it's a dove because it's all white and stuff."
...
"I wish I was home."
"My friends are probably still sleeping in, enjoying their warm, heated houses and all that."
"I can't focus here."
...
#! one of the "only"s needs to go
"It only takes him a few seconds to get ready before firing."
...
#!! "were not" -> "weren't"? Not sure if Sydney's dad speaks like that intentionally or not
dad "\"You weren't listening to what I was telling you! Just like what I was saying this morning.\""
"Dad's voice raises."
...
#! a comma here makes it more obvious that "and you" is not being combined into the group of "all the kids around Echo" on first read
...
unk "\"What?!\""
#! Not sure if vans can be called "trucks"
"From the hood of the van, little rivers of blood splay out from the duck's chest, dripping down the front of the grille."
"Its eyes are still open, even though it's dead."
...
"..."
"I smear away the dust from the glass and press the tip of my muzzle against the window."
"Nothing."
"What the hell..."
scene bg van1
...
"Sunlight peeks in through the beige drapery, but everything outside is just a pale glow. I can't gauge what time it is."
...
t "\"You would really like our campus's cafeteria.\""
...
if carl_mood == "3rdhole":
    ...
    ""
    "..."
    "I stare at the message for a good eight seconds before remembering Carl's shtick."
    "God."
...
#!!! They use keycards to unlock the door, not metal keys
...
"There's some gray fur tucked in the corner, so I'm guessing TJ took one this morning."
...
#!! Semicolon or period or something here
...
da "\"I hope he does.\""
m "\"I can't help but think a lot of things could go wrong, you know?\""
...
"I fidget with the inside of my pockets, trying to look nonchalant."
...
f "\"It's got to do with personal stuff.\""
da "\"Oh really?\""
...
"I look in my rearview mirror at the ram, who still isn't saying anything."
"Hopefully not many."
...
#! probably? This is copy-pasted from Carl's route and probably forgot to change since Flynn is there
m "\"Okay, cool. We'll be waiting!\""
play sound "cardoor.mp3"
...
#!!! Not sure who is wiping whose face, could replace some of the pronouns with names. This is a copy from Carl's route so I assume Carl is wiping his face again
"Carl takes them from me wordlessly and starts wiping his face."
...
f "\"Eh, not everything.\""
f "\"Come on, let's go.\""
#! Too many he/him pronouns
"Flynn starts to pull on his arm, but Carl yanks it from him violently."
c "\"Don't touch me!\""
hide Carlalt
hide Flynn
...
#! Next few lines are switched around so Carl's voice breaking apart actually happens next to his line instead of Flynn's. Otherwise it reads like Flynn's voice is breaking apart.
...
#! Carl is sitting in the backseat in this route, not the passenger seat like in Carl's route
"I look back at him, scared to say anything in case I say the wrong thing."
...
"I was heading toward the mailroom, but that catches my attention. I stop."
m "\"What?\""
...
menu:
    "Pry." :
        ...
        f "\"Just gimmie a minute, a'ight? I need to talk to lardass.\""
        f "\"Do your shit.\""
        m "\"Ugh.\""
        "I rub the space between my brow and step out of the room."
        show frontdesk4 with dissolve
        "The mailroom looks a little different, for some reason."
        ...
        "I'm stepping around the pile when I hear the sound of Flynn's raspy voice from the other room."
    ...
    "Head to the mailroom." :
        ...
        "I step past Carl and make my way to the mailroom."
...
"I plug in my keychain thumb drive to the printer and begin scanning."
...
"I remove my thumb drive and turn the power off for the scanner."
...
#!!! Needs some tweaks and focus. "Leo was like a year younger than Flynn" might be more clear. I assume the "he" in the second half is Leo?
"I mean, Leo was like a year younger than Flynn, but he didn't really act like it."
...
"It gives the office a sort of flower garden scent that doesn't really match the aesthetic."
"Black, white, and red everywhere."
"Like a supervillain who could only buy hobby shop decorations."
#! this could be ", which" or "that" but "that" reduces the repetition of "which" on the next line
"I step over a small pile of alabaster quartz that sits in a ceramic dish on the floor."
"Which is strange, of course."
"There's a weird-looking globe on the edge of her desk, too."
scene bg officeglobe with dissolve
"I step closer and notice several little prongs that hover over what I think is the meridian."
...
show TJ Sheepish with dis
t "\"Oh.\""
"He frowns in acknowledgment, nodding."
...
#!! "but" and "though" in the same line is redundant I think? "too" keeps the same effect
t "\"..but I didn't know that you would be here, too...\""
...
"TJ says nothing, the lynx standing next to a small pot that he keeps bouncing his foot against."
#!!! "adam's apple" should be capitalized, which then reduces readability. Consider reworking it out of the sentence entirely
"I see Flynn's throat bob, the gila wetting his palate like his whole mouth has gone dry."
...
menu:
    "Stand beside Flynn." :
        ...
        f "\"All details. I don't care what'cha think is insignificant or not.\""
        ...
        f "\"And Leo?\""
        #!! Is there a reason this "finding skipping stones" line isn't in the other branches?
        ...
        "The room goes quiet."
        #! to match the other branches, and it reads better
        ...
        j "\"{i}Your{/i} office?\""
        "She lets out a quick, exasperated breath."
    ...
    "Stand beside TJ." :
        ...
        if House_Talk == "Daxton":
            ...
            j "\"The truth is that Sydney had an accident and died.\""
            j "\"And you are completely unable to accept that. You are not the only person who has lost someone.\""
            j "\"The way you choose to make yourself feel better is by bringing everyone else down with you. That's unacceptable.\""
            f "\"You can't let go, can ya? Just a total control-freak who thinks they know what's best and who deserves what.\""
            f "\"We all know you hated Syd the most.\""
            f "\"Hell, you told Carl you were glad he was dead years ago, and guess what? He told me.\""
            "Carl looks down at his hooves."
            ...
            l "\"Flynn!\""
            #!!! Maybe check all these "and I do our best to get out of the way" sections. It's not clear why it's Carl in the TJ->Leo split and TJ in the TJ->Daxton split
            #!!! It doesn't seem consistent in the other branches also
            "Carl and I do our best to get out of the way."
            "He doesn't even notice me."
            "Flynn stands straight up."
            f "\"What?\""
...
menu:
    "Condemn Flynn." :
        ...
        m "\"I'm not just your damn toy that you can use for your stupid plan.\""
        ...
        with dissolve
        #! reduces repetition of "would"
        c "\"Dudes, Flynn wouldn't hurt TJ. I dunno why you guys think that he would.\""
        ...
        "Leo tosses such a fierce slug of a punch that Flynn's face looks like it vibrates in place."
...
menu:
    ...
    "Condemn Flynn." :
        ...
        "The lynx gestures, opening and closing his paws in front of his face."
        t "\"Everything after that got fuzzy.. like I was dreaming.\""
        #!!! Removing these two lines since other branches dropped them ("I saw something just under the water." and "I-in a completely different spot.")
        t "\"Two bodies, both had brown fur - that's all I could see.\""
        t "\"Undulating i-in this.. constant, restless motion.\""
        scene bg frontdesk
        show Flynn Annoyed at farleft
...
"TJ squints, his nose pressed against the windowpane."
...
"On the abdomen, there's a splotchy pigmentation of red. The number eight."
"My pulse quickens when I realize it's an hourglass."
"Black widow."
"Oh my God."
"Oh my God, oh my God, oh my God..."
#!! "just" should probably be dropped here? Chase's fur isn't "moving" at all, while "just" implies "in addition to"
"I look down at my arms again and realize it isn't my fur moving."
...
#!! this needed some words, and I didn't like "upon on". Could use some other phrase instead
"I see the webbing of the nest I had sat upon attached to the fabric of my shorts - oodles of the baby and not-so-baby spiders crawling out."
...
"Spider blood isn't red or green like it is in video games or movies."
...
#!! "out my mouth" -> "out of my mouth"?
"I reel forward as it all comes spewing out of my mouth."
...
menu:
    "Find him.":
        ...
        "It's at that moment that I start feeling a bit silly."
        ...
        #!! County Sheriff? county sheriff? not sure on capitalization
        ...
        "Dude's gonna grow up on dumb movies and video games and have no clue how the real world works."
        ...
        "None of the group are really into this stuff, so it's pretty a'ight when I'm wanting to be alone."
        ...
        #!! maybe?
        "I'm about to fire, but a nearby rumbling sound starts coming from the road about a mile north."
        ...
        f "\"Whoa, the hell's going on, dude?\""
        ...
        play sound "cardoorhalf.ogg"
        "I throw my equipment in the truck bed before opening the driver-side door. Sydney's already sitting on the passenger side."
        ...
        f "\"Wanna tell me what's up?\""
        "Sydney says nothing."
        f "\"You ain't been killing hookers again, have ya?\""
        f "\"I know the bitches step outta line sometimes and ya gotta keep your pimp-hand strong, but there are limits, little guy.\""
        "I smirk at him."
        ...
        "The alpine wind air freshener that dangles from the rearview mirror."
        play sound "cardoorhalf.ogg"
        ...
        #! I think this should be "moreso" due to how it's used, whereas all other instances are "more so"
        f "\"Moreso than what really happened.\""
        ...
        "As I turn and head back to the van, it's like this physical sense of dread is hugging me the closer I get."
        ...
        "The van jostles and teeters as it careens down the dirt road before the turnoff to Wilma Bend."
...
"He's draped in a striped blanket, sitting upright and looking a little frazzled."
da "\"Flynn? Uh...\""
...
if House_Talk == "Daxton":
    ...
    f "\"What party?\""
    da "\"The group, they had a cookout thing at Chase's place and Carl invited me along.\""
    da "\"You didn't know?\""
    "Fucking figures."
...
#!! probably? If it was unconscious he wouldn't remark on the action
"I subconsciously rub at my own eyes. Still there, as far as I can tell."
...
if House_Talk == "Daxton":
    ...
    #!!! this could use a stronger pause in the middle
...
"To think, 30 miles away, Payton's bustling with 100,000 people all enjoying their Saturday night."
...
"I had expected there to be a giant hole in the ground the size of Echo Canyon, but there was pretty much nothing."
...
"Just slap a plaque up there with a little blurb about all the death and shit. It'll make a great selfie spot."
...
show Daxton Annoyed with dis
da "\"Gosh damn Asperger's and french fries, I swear...\""
...
c "\"Just kinda wanna go home and play video games without getting shot.\""
...
f "\"Er...\""
#!!! Chase already told Flynn that Carl knows, so this doesn't really track - the line where this happened was "I ended up telling him the whole truth though"
...
f "\"Yeah.\""
"I look offward, peering at the sorry state my room is in at the moment."
...
f "\"He even plays video games and does all that other nerd shit you like that I don't.\""
c "\"You game sometimes.\""
f "\"Yeah, only because you do.\""
c "\"I guess.. that's the point, isn't it?\""
"He scratches at his beanie, a bit of his headfur peeking out from the horn holes."
...
"His fur is coarse."
"Not quite to the point that it's pricking me, but it has its weight to it."
...
f "\"Ffff-\""
"I suppress a grimace just as the ram lifts his head up enough to meet me eye to eye."
c "\"Sorry.\""
...
"I open my mouth to protest, then just let out a quiet 'eugh'."
"I have to will my tail to not curl in on itself."
j "\"Then again, I'm pretty sure you don't drink plain water.\""
"She seems to be looking up at Carl."
...
if House_Talk == "Daxton":
    ...
    "His skin's so tightly stretched across his body, it makes even the slightest change of his face readily visible."
...
j "\"When we were younger, one of our neighbors - our friend - drowned in Lake Emma.\""
"She pauses."
show Jenna
...
#!! Daxton's character sprite could use a change for his reaction below
da "\"What?\""
...
f "\"Or fuck it, maybe they both are and are covering for each other's asses.\""
...
if House_Talk == "Daxton":
    ...
    #!! this is a weird time for TJ to interject he's not lying, since the topic isn't really on Chase being a murderer atm?
    t "\"I'm not lying...\""
...
show Jenna with dis
j "\"TJ..\""
"Jenna rubs her paws on her napkin, wringing it some before speaking again."
...
"The salamander walks around to where TJ's sitting, then points to something behind him."
da "\"Like this?\""
...
"I give him an incredulous look as we meet each other's glances for a second."
f "\"..yeah?\""
...
"He mentioned how vivid everything was, and how fuckin' Jeremy wouldn't stop laughing."
...
#!!! quoting "horrors away" is odd. Maybe just "horrors", or the full "melts the horrors away"?
"Usually the moment shit starts getting remotely bad, he tokes 'til his mind melts the \"horrors\" away, as he calls them."
...
if House_Talk == "Daxton":
    ...
    #! this was probably technically okay before, but this is more natural
    "Leo continues to eat, the only one of us still doing so at this point."
    "Daxton gawks at him."
...
"Her demeanor seems to shift, her posture not as full of that holier-than-thou air that she usually seems hell-bent on putting on."
...
"Leo's quiet as he drives, occasionally checking the rearview mirror."
...
"As we make the turnoff onto Margaret Street, I spot the familiar dust-covered, plastic flamingos that adorn Auntie's yard."
"The manufactured house was built back in the '80s, and still dons this sorta faded, turquoise color scheme."
"She added these pink, diamond-shaped bathroom tiles all around the roof's edge a couple years ago, too."
...
j "\"It's probably still best we speak with the mayor. Perhaps with what's going on, she'd return to City Hall?\""
...
#!!! Not fixable at this point, but wouldn't this be like a 5 minute drive tops? Echo is a small town I imagine
...
f "\"She's not.\""
#!! not a big deal, but "everyone away outside" is a little awkward
...
#! reduces repetition of "her"
"Her fingers flick along various pages within a manila folder, her tropical flower-print scarf swaying with every movement."
...
f "\"You told him!?\""
"I glare down at the ram, who quickly throws up the flats of his paws defensively."
...
#!! probably? the vomit on the floor is probably in the reading room
#!! if it's on the floor outside where they currently are, why would Flynn continue "stepping in" it instead of moving his foot - i.e. past tense?
"There's also dribbles of vomit on the floor, which I had the misfortune of stepping in."
...
"I feel a weird tingle in the back of my neck."
...
"Don't wake up."
"Daxton crouches down beside him, pulling back some of the fur around his collarbone and showing the swelling red skin beneath."
...
"The salamander returns, clutching the thick metal case that looks like it's from the '90s."
...
"I try to keep my voice steady, though my vocal cords shrill a bit as I say his name."
...
m "\"Toby was talking about Sunday school or something and Sydney just took the cone and started trying to stab him with the pointed end.\""
...
c "\"Whoa, man, don't you have like some spare touristy shirts and stuff around here somewhere?\""
...
"The air has this sorta smoky tinge to it, like someone's cooking something."
...
with dissolve
"At the sight of us, he pushes his way through."
...
if House_Talk == "Daxton":
    ...
    "There's a long moment where Leo is just looking at Chase's face, his expression shifting from the wide smile to a more vacant stare."
...
"I recognize the faded logo in the corner as the one from Southwest Adventures. An old souvenir, maybe."
...
#!!! could use a stronger pause here
...
if House_Talk == "Daxton":
    ...
    "He speaks with such idle nonchalance, not bothering to clarify what 'it' is."
...
du "\"And they'll continue to get hurt 'til we stop this.\""
...
#!!! fairly sure this should be "van"?
"I can see Jenna moving by the edge of the van."
...
ma "\"James Hendricks's Notice of Death.\""
...
"It's for a \"\James Hendricks\", who passed away in 1913."
#!!! poison(ous) -> venom(ous)? This sort of implies that James ate a spider otherwise. "Poison" here may be more natural than "venom" as a cause of death?
"The cause of death is listed as \"\poison/infection (theraphosidae - tarantula)\"."
f "\"Tarantula.\""
...
menu:
    ...
    "Raise the repeater.":
        ...
        show nightoverlay
        with vpunch
        "I step over and knock the gun out of his paw."
        ...
        if House_Talk == "Daxton":
            ...
            #! Not sure why Leo is not referenced before his pronouns?
            "I basically have to drag Leo by the shirt to get him to come with, the wolf snarling and swearing in his native tongue the whole time."
            ...
            "I scoff."
            f "\"The fuck he will. Now shut up.\""
            f "\"We're leaving.\""
            "Auntie moves over beside me, resting her hand on my shoulder."
            ma "\"Flynn, you can't make this decision for everyone.\""
            ma "\"There's something wrong with y-\""
...
play background "highway.ogg"
scene nightroad
"I stare into the rearview mirror, watching for any signs of taillights in our wake."
...
#!!! "or" maybe even her mother?
"I see Jenna look out her own window intently, and I can only imagine it's to see if she can spot Jeremy or maybe even her mother."
...
if House_Talk == "Daxton":
    ...
    c "\"I saw it in the rearview mirror first.\""
    ...
    #!!! These next two lines seem like they should be split out depending on whether Flynn used his gun or whether Daxton got to give his speech?
...
l "\"Mh?\""
"Leo turns his head in the direction of something on the curb up ahead - we all do."
play music "heartbeat.ogg"
l "\"What is that?\""
t "\"Oh my gosh...\""
...
#! the other copy-paste of this section uses this colon structure, and I think it's cleaner
...
#! notable that chase is in his underwear I think? Secret pocket?
...
"I pull back the hammer on the repeater, holding the rifle across my chest with the barrel pointed toward the window."
...
c "\"Bluuuuurgh...\""
#!!! This is a copy-paste of the other section, except Flynn is the POV and not Chase. Not sure if this still sounds natural
"Some dry retching noises followed by heavy splattering sounds cut Chase off."
...
"...with that thing."
#! probably? Unless this was intended to be "stay watchful"
"I shake my head, trying to keep watch for any sign of movement."
...
if House_Talk == "Daxton":
    ...
    #!!! not sure I understand the connection between her holding Duke's pistol and needing to speak calmly?
    ...
    #!!! not sure what this sentence was supposed to be; needs rewording
    "Leo is sitting upright, moving rigidly like a goddamn automaton."
    ...
    "Jenna lets out a strange sigh. It's laden with her common exasperation, but there's a slight quiver in her vocal cords."
    ...
    #! maybe?
    "Leo doesn't react right away, but then out of the corner of my eye, he slowly begins to turn his head to look directly at me."
    ...
    #! "wide-eyed looking" is too awkward
    "A wide-eyed Jenna holds her smoking pistol up and fires again."
    play sound "gunshot.ogg"
    ...
    #!! This has a 4th line wrap, and the Leo split of this branch looks like it attempts to fix that. Maybe copy those changes over?
    ...
    "Leo pauses, waiting for an answer."
    m "\"What? Sure...\""
    ...
    "Part of me wonders whether Duke and Chase's car are still there, and we just imagined that whole grisly scene."
    #!!! the bg hill_small and bg hill_monster_small images were reversed in the next lines (and misnamed)
...
###
    ...
    "..only to flip around and go the other way again."
    "Jenna lets out a strange sigh. It's laden with exasperation, but there's a slight quiver in her vocal cords."
    "We keep going and more time passes."
    "Daxton mutters something I can't quite make out to Carl, who has been oddly silent - his paws over his face."
    "I occasionally catch Chase looking at me in the rearview mirror."
    "Despite his shit with the spider bite, he looks more.. well, animated than I've seen him in a long time."
    ...
    "It's unclear whether he's glad or upset that the grisly scene is straight up gone."
...
c "\"Uh.. uh, okay!\""
"There's a shuffling movement, followed by a hard slam."
play sound "windowbreak.ogg"
...
"Soon the water's up to my nostrils, and my blood goes cold."
...
"I look around the mass of bobbing heads that surround me, but neither Daxton nor whatever attacked us is anywhere in sight."
...
f "\"Fuckin' 'ell, he's probably still all the way down in the van!\""
c "\"We gotta get him!\""
...
"I swiftly doggy-paddle my way over, grabbing the ram's arm and forcing it around my shoulder."
...
if House_Talk == "Daxton":
    ...
    "I can't bare it anymore, I have to come up for air."
    ...
    "All my adrenaline is completely tapped out at this point, and I fall to my knees in the sand."
    ...
    da "\"You were all.. red.\""
    f "\"Red?\""
    #!! This run-on sentence sort of makes sense in the context of Daxton being panicked, but from a reader's perspective it is still difficult to parse
    ...
    "He holds up the flats of his palms, shaking his head."
    ...
    c "\"Whoa, that's two saves now, dude.\""
    ...
    "TJ peers back over his shoulder. He's still looking at Chase."
    play sound "drygrass.ogg"
    ...
    "My muscles are already starting to feel rubbery, and the urge for heat is strong."
    ...
    m "\"Thanks, Flynn...\""
    show Chaseu Cover at center behind nightoverlay with dissolve
    #! matching this a little closer to the other branch, since that one reads better
    "Chase uncoils himself from me, his voice wheezy, and he breaks out into a raspy cough."
...
"We meet each other's gaze, and Carl suddenly lets out a small chuckle, rubbing the space between his horns."
...
#! reduces repetition of "his"
"Daxton toys with the zipper at the bottom of his hoodie."
da "\"..musta gotten ahead of me.\""
c "\"It's okay.\""
c "\"I think we're supposed to be here.\""
c "\"Right, dude?\""
"Carl looks to me."
#!! paranatural isn't normally a word, is this intentional?
...
if House_Talk == "Leo":
    #!!! These first three lines might as well be shown to both the Daxton and Leo split
    #!!! Otherwise, during Daxton's split, it's super weird when Flynn says "hey that thing didn't intentionally try to kill us", and Daxton, who very nearly drowned, has nothing to say about that
...
#!! I think this sentence structure implies not only that he drowned "here", but also that he died in a hospital "here"? It's not super noticeable if you're just skimming
...
#!!! Daxton already knows how Sydney died - Jenna tells him at Flynn's house. These next few lines sort of imply he had never heard of it before
#!!! the previous line is "When we were younger, one of our neighbors - our friend - drowned in Lake Emma"
...
"Despite all the water and vegetation, the air still feels kinda dry and smoky."
f "\"I wonder where that fire's comin' from.\""
"..."
"No response."
#!! consider switching this to e.g. "I look over and see Carl and Daxton sitting together", for a minor improvement in readability. Using "X and X and X" makes me do a double take on how to read it
"I look over and see Carl and Daxton sitting together, watching the tide. They look as tired as I am."
...
"It's been about fifteen minutes, and so far no sight or sound of the gang, or any other miscellaneous townsfolk."
...
"The back of my skull tingles, and I cup my hands over the sides of my head."
...
"I'm not usually the sort to do my running in Echo on account of the century's worth of broken glass that lines the sides of the roads."
...
"I eye the truck through the bars, then check to make sure I still have my keys in my pocket."
...
menu:
    ...
    "Break the lock.":
        ...
        #! to match the other branch. Less clunky
        "I stare at the lock, feeling some fleeting sense of accomplishment."
        "It soon falters as I note that the lock being there in the first place doesn't make a lick of sense."
        f "\"What in the fuckin' fuck...\""
...
#!! "to the horizon" needs some changing; I think "on the horizon" fits but something else could work here
"The red lights from the building make it seem as though the sky itself is blood-red, expanding to various pinkish hues on the horizon."
...
"He's holding something to his head.. an ice pack, and he's nursing some shitty import pale ale in his free paw."
...
"It's then I notice his eyes: baby blue.. almost gray."
...
"He seems to perk up some, doing a one-handed finger gun gesture my way while the other nurses an ice pack against his head."
...
"Facade or not, my legs are killing me."
f "\"..sure.\""
scene bg barside
show nightoverlayred
with dissolve
...
#!!! "can almost quite make out" feels weird to me. Drop "quite"?
"For a brief, fleeting moment, I can almost make out the little mop-and-bucket symbol posted in the center."
...
"There, to my knowledge, have never been advertisements for spiced beer nuts posted outside the bar here."
f "\"Jesus...\""
...
"He frowns, shifting his ice pack back to his noggin."
...
"Like, he'd been preparing to speak to me for some time now, and I've completely derailed his plans to get a lot of the shit he wanted to say off his chest."
...
sy "\"How would you even know what a dream was if you had one? After all, you look more like you just woke up.\""
...
sy "\"I'm your goddamn best friend. Hell, you're like my gay, scaly brother.\""
...
"The sick heat left forgotten in conversation begins crawling up my back."
...
"I look up, and she's still standing there - mouth agape, like she's frozen, but her eyes follow me in real-time."
...
"He looks like Carl."
"The ram pivots on his hooves, turning to walk away but stopping when he sees me, his expression vacant."
...
"Carl and Dax both turn and flee - the salamander screaming his absolute lungs out."
...
"..."
play sound "catchfire.ogg"
#!!!! It's a little weird to show the river image during this scene. Why not the lake?
...
"I turn to see a faint gray silhouette, with big, blue eyes."
t "\"Wha-..what?\""
...
#!! "does not" -> "doesn't"?
"He doesn't move, though I can read the intent in his eyes that he very much wants to."
...
unk "\"..are you real?\""
"I think for a moment."
#!!! "Then slowly," -> "Then, slowly," for greater emphasis?
...
"It was nothing like this in his hometown, and he found himself wishing he was back amongst the pine forests."
...
#! needed some differentiation with pronouns here.
"Devon points the lens at the coyote, who quickly covers his face - letting out a frustrated sigh."
...
#!! Had to do some re-arranging to make this readable. Also I have no idea what the end of this sentence was supposed to be but I took a guess?
"It's not a pleasant walk - most of the infrastructure is in pretty shoddy condition, overgrown in places with sagebrush and dry vegetation."
...
scene bg cityhalloutside with slow_dissolve
"Eventually, the two reach the old town center."
...
#!! Could use a differentiation of which pronouns are Devon's
"The sun's behind him, so it casts his front in shadowed silhouette - giving him an eerie visage that Devon might be able to use in the video."
"The civic building's roof is fully collapsed - a faded, gray tarp over the top of the walls all that's protecting the interior."
...
#!! Cam and Dev are not in college in 2020 I think?
...
if House_Talk == "Daxton":
    ...
    #! maybe?
    m "\"Yeah, I guess. My ex still lives down off Gretchen Way - you know, by the old rail yard?\""
    "Devon nods."
...
dev "\"Ah.\""
"Chase takes a long drag from his cigarette, stopping at the first speed bump."
#!! Again, I don't think Cam and Dev are in college in 2020?
...
"He's awfully haggard for someone in his mid-to-late 20s, his facial scruff untrimmed and the dye-job looking less than stellar."
...
"Said sad eyes are fixated upon the civic building now, Chase's lips thinning tightly around his cigarette - squeezing ash from the tip."
...
"Eventually they arrive at the outskirts of the nearby mine - warning signs posted damn near everywhere."
...
dev "\"'These kinds of things'?\""
dev "\"What do you mean?\""
"Devon quirks a curious brow towards the coyote, though judging by his grimaced reaction, Cam regrets bringing it up and doesn't speak further."
