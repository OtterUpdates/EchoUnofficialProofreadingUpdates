...
"Leo took on a real stoic, statueesque expression, Carl gave a dopey smile and made a peace sign, and Jasmynn put on her best 'sassy' look."
...
"TJ takes friendship seriously, and I can't help but feel that's a quality in someone that would be really nice to have by me right now."
hide phone
...
centered "_"
"I'm a bit startled for a moment there at the whole 'sweetie' thing before I realize what's happening."
play sound "texting3.ogg"
...
k "\"Especially with kids.\""
"I'm not sure what she means by that and definitely am not sure what to say. I look back at Carl."
"He is averting his gaze now, his paws deep in his hoodie pockets."
k "\"... Alright, alright, I get it. Nobody trusts the hick bus driver to know what its like to be a kid these days.\""
k "\"Look, run along now. Sorry for, ya know, grabbin' ya. I'm used to them shits Jeremy and Clint doing that and gettin' {i}me{/i} in trouble.\""
"I try hard and force a smile."
m "\"Oh, uh... thanks. I appreciate your concern and all. Er, yeah, they are pretty... shitty.\""
k "\"Hey! Language, kiddo.\""
...
m "\"I'm not sure what you mean by 'in general', but yeah, around here in Echo.\""
...
show Carl with dis
c "\"{b}SATISFACTION, SATISFACTION{/i}.\""
...
m "\"You think Flynn actually is into that sort of thing, or that's just a running joke?\""
...
c "\"Way I see it? Most people don't actually play football for the game in high school. It is all about like... the status.\""
if partner_choice == "Leo":
    m "\"I tried messenging him earlier because I wanted to... talk to him about something pretty big-like.\""
...
"Carl shrugs."
c "\"Maybe.\""
c "\"We just got to get in and look for TJ's little, grey ass.\""
...
show Carl Dejected with dis
m "\"Whatsup TJ? Why are you dressed like a ghost?\""
...
"The ram holds up the flat of his paws to the sheeted one."
...
t "\"I mean, its okay to have a plus-one if Leo's here, right? But there are three of us.\""
...
"Looking around, there are actually quite a few lit candles lying about, their flames contrasting with the colored gel-matted halogen lighting."
...
t "\"... I didn't know whether to let you rest on the mattress or not. I know you're not really a fan of spiders, and there was a few along the stitching.\""
...
m "\"Look, Teej, he was a jerk. A drunk jerk. Out of all things to beat yourself up over, that's not one.\""
...
m "\"Woah, no, that's just guy talk. I don't think the others in our group are gay. Like... what are even the chances of that?\""
...
l "\"Chase!\""
"The familiar russet-colored wolf emerges from around the corner, his red eyes flicking to from me to TJ, and finally, to the mango in my lap."
...
"He's still probably blaming himself for everything, too."
...
"He squints down at it for a moment, then exudes a low snerk, covering his forehead wtih his paw."
...
"I exhale and refocus, shifting my attention to the big ol' wolf currently holding my hand at looking at me expectantly."
