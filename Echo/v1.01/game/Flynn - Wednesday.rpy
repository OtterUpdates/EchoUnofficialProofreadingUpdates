...
"I feel a little flare of annoyance at the thought of how much I'm putting into this and how little I'm getting out."
...
#!!! maybe? Not sure what the intended flow is here, but something should be added to make it more readable
...
"I look back at the door and can tell right away that there isn't anything holding it shut, at least not on the outside."
...
"TJ seems to have cheered up since the incident a few days back."
...
#! probably?
"Jenna has a fair point, but I still feel bad for the wolf."
...
#!!! the "ram's face" description line was missing in this route, which makes "one of those horns" confusing. Adding it back seems fine.
...
show Carl with dis
#!! removing repeated "before"
"Carl gives Flynn a small smile before flicking the lighter on, then snapping it shut."
c "\"Thanks, man.\""
f "\"Don't worry about it. Store owner actually gave me a discount. They still remembered me from all the smokes I used to buy there.\""
...
#!! both ways technically work, but this feels a lot more natural
l "\"Can't you read a fucking room!? No one wanted you to say anything to him!\""
...
"We both listen to the sound of Leo's van starting up before it fades as they pull out."
...
#! probably?
m "\"Well, yeah, but that doesn't mean I can't get a few shots of the outside.\""
...
#! Daxton's dialogue could have an "unknown"/"???" tag until he's introduced, like Kudzu did
da "\"That you, Flynn?\""
...
#!!! ", but" is repeated twice here. could be reworded to be less clunky. I took a stab
"A tall lizard comes in, but it's not his height that surprises me, it's his coloring: spotted blue with pale eyes."
...
#! maybe? Also maybe italicize chiles rellenos?
...
"At the same time his hands grab the bottom of my shirt and pull it over my head, breaking our kiss."
...
"I feel Flynn tense and start to step back, but I slide my hands up his thighs and squeeze his ass again, keeping him firmly in place."
...
#! probably?
"While Flynn is definitely quicker to cum, it isn't quite as much as Leo, so I have no trouble getting it all down."
...
#!!! "with the hand on my head" feels a bit verbose and repeats "my head". Yanking back implies using a hand, so this seems like an okay fix. could be reworked further
"He yanks my head back, his slick dick bobbing from my mouth."
...
#!!! not sure what to do with the first part of this sentence, but it needs something different
