...
"I frown to myself as my thumbpad hovers over TJ's contact image on the messenger app."
...
"Leo took on a real stoic, statuesque expression, Carl gave a dopey smile and made a peace sign, and Jasmynn put on her best 'sassy' look."
"Flynn just stuck his weird, forked tongue out..."
"... and TJ gave a proper, polite smile, as if the idea of being silly didn't even occur to him."
"I guess in his mind, I'd made a request and he wasn't about to... 'sully' it or do something for a laugh."
"TJ takes friendship seriously, and I can't help but feel like that's a quality in someone that would be really nice to have by me right now."
hide phone
play sound "texting3.ogg"
show cellT 1 at center
centered "_"
"I'll keep it vague at first. Dropping a bomb might just confuse him into thinking I'm making some sort of lewd joke."
play sound "phonebuzz.ogg"
show cellT 2 at center
centered "_"
play sound "texting2.ogg"
show cellT 3 at center
centered "_"
"I feel a bit bad not really indulging in returning TJ's chipper mannerisms, but I just really don't have it in me right now."
play sound "phonebuzz.ogg"
show cellT 4 at center
centered "_"
play sound "texting1.ogg"
show cellT 5 at center
centered "_"
#FIX THIS-----------------------------------------
"I know TJ goes to a lot of different 'functions' in his free time."
"He's kind of a popular kid, though pretty much all of them are based around church and community service activities."
"They're pretty much never in Echo, though. The only church we have in town is the old abandoned one from the Mormon Trail days."
"I think it turned into a school briefly during World War II, though it shut down soon after. The county tried to make it a tourist thing once, but it didn't work."
"Back when my parents still went to church, we had to drive all the way out to Payton at 7:00 in the morning. I hated it and would whine and complain every time."
"Sometimes I carpooled with TJ. The vibe was completely different. They'd discuss Bible verses and talk about their weekly self-betterment goals."
"I think I remember getting in trouble because I kept calling everything 'dumb' when I was in the car with them one morning. I was really cranky."
"After that, my parents made me ride with them."
"In contrast, my folks usually just left on the talk radio and we drove in silence."
play sound "phonebuzz.ogg"
show cellT 6 at center
centered "_"
"I'm a bit worried that this party will just be another acoustic-guitar, arts-and-crafts-with-the-elderly affair."
"But the more I think about it, the location strikes a tad weird-like."
"Parsons is sort of out in the boondocks of Echo, which is still technically the middle of goddamn nowhere."
play sound "texting3.ogg"
show cellT 7 at center
centered "_"
"Were it any other time, I'd pass, but not tonight."
play sound "phonebuzz.ogg"
show cellT 8 at center
centered "_"
"I'm a bit startled for a moment at the whole 'sweetie' thing before I realize what's happening."
play sound "texting3.ogg"
show cellT 9 at center
centered "_"
play sound "phonebuzz.ogg"
show cellT 10 at center
centered "_"
play sound "texting1.ogg"
show cellT 11 at center
centered "_"
play sound "phonebuzz.ogg"
show cellT 12 at center
centered "_"
play sound "phonebuzz.ogg"
show cellT 13 at center
centered "_"
"Oh my god..."
"I did not expect when I started texting TJ that five minutes later, I'd be forced into a conversation about my musk glands with his mother."
play sound "texting2.ogg"
show cellT 14 at center
centered "_"
hide cellT with dissolve
...
"Texting TJ (and his mother) did not help at all."
"I can see that we're approaching Carl's stop."
"The bus turns onto the neighborhood road and I scoot over some, speaking up to get Carl's attention."
...
"She pauses, bending down to pick up the dropped note and tossing it in the bus's trash bucket."
...
"Carl currently looks as if he's trying to camouflage into his seat, slowly sliding down it."
k "\"S'aight.\""
...
k "\"Especially with kids.\""
"I'm not sure what she means by that and definitely am not sure what to say. I look back at Carl."
#! Sync from other duplicated sections
"He's averting his gaze now, his paws deep in his hoodie pockets."
k "\"... Alright, alright, I get it. Nobody trusts the hick bus driver to know what it's like to be a kid these days.\""
k "\"Look, run along now. Sorry for, ya know, grabbin' ya. I'm used to them shits Jeremy and Clint doing that and gettin' {i}me{/i} in trouble.\""
"I try hard and force a smile."
...
"I see Carl stiffen, quickly reaching down and fumbling with his zipper, his neon orange SuperWolf boxers visible through his fly."
play sound "phonebuzz.ogg"
"Karen just sighs. I feel my phone vibrate in my pocket."
k "\"See you squirts on Monday.\""
play sound "busstopsdeparts.ogg" fadein 2.5
jump contj2
...
show cellT 15 at center with easeinbottom
"I follow, pulling out my own phone."
"..."
"Oh."
play sound "phonebuzz.ogg"

show cellT 16 at center
centered "_"
c "\"I don't know, I was just grabbing what I needed. 15 bucks, maybe.\""
hide cellT with easeoutbottom
"I refocus briefly, glancing over toward Carl."
m "\"That's a lot for one of those kinds of games — especially just for clothing.\""
play sound "phonebuzz.ogg"
window hide
show cellT 17 at center with easeinbottom
$ renpy.pause(15.0, hard=False)
window show
c "\"Well, like... the luchador mask I wanted was one of the 'Premium Items', so it cost the most. Everything else was dirt cheap.\""
...
c "\"I'm just trying to be unique. Otherwise, what's the point? It's a social roleplaying game. Why risk getting ignored?\""

c "\"I uh... actually have another account with a character that is more normal-looking.\""
...
window hide
show cellT 18 at center
play sound "phonebuzz.ogg"
$ renpy.pause(10.0, hard=False)

play sound "phonebuzz.ogg"
show cellT 19 at center
$ renpy.pause(0.15, hard=False)

play music "bent.ogg"
show cellT 20 at center
$ renpy.pause(10.0, hard=False)
window show
...
c "\"It's sorta like you said: most of the people there are just middle-aged housewives who can barely type a sentence.\""
c "\"But then I sorta went... 'off-grid', I guess you'd call it?\""
play music "doublewalk.ogg" fadein 4.0
show cellT 21 at center
play sound "texting2.ogg"
...
c "\"There were these places that looked more like real-life houses — not the usual fantasy, exotic stuff.\""
...
c "\"They had decorations with Middle-Eastern script everywhere, but they seemed normal enough.\""

c "\"They had a TV item that just displayed a slideshow of photoshopped photos of them with a baby.\""
...
show Carl behind cellT at center
show cellT 22 at center
play sound "phonebuzz.ogg"
...
m "\"Yeah, just... texting TJ.\""
m "\"Or... well, his mom.\""
show Carl Teasing with dis
c "\"Nice.\""
m "\"Dude.\""
show Carl with dis
"I look up the street, Carl's house sitting in its amber-glowing glory atop the hillslope."
m "\"Apparently there's a party happening tonight.\""
"Carl raises an inquisitive brow."
c "\"Like... {i}here{/i} or in general?\""
m "\"I'm not sure what you mean by 'in general', but yeah, around here.\""
m "\"TJ got invited. Guessing it's for Day of the Dead?\""
show Carl Neutral with dis
c "\"What? He didn't mention it to me at all, and I asked him to his face if he was doing anything tonight.\""
"I shrug."
m "\"Well, you aren't really the type for social events.\""
show Carl Depressed with dis
"Carl shifts upon his hooves, his posture faltering."
c "\"Yeah, but... it is weird that he wouldn't mention it.\""
...
show Carl Neutral with dis
c "\"... but seriously, a party in Echo? Can't be for some churchy thing in this land of heathens.\""

m "\"It's... well, it's at the Parsons Manufacturing Building on Route 65.\""
c "\"That's sort of in the ass-end of nowhere for a party, too. Maybe it's like a rave or something?\""
"A mental image of TJ in neon hot-pants with glowsticks and a rave whistle comes to mind."
"... which is weirdly kind of hot."
m "\"Yeah, don't think TJ is the trance-and-techno type.\""
c "\"Maybe he just wants to get his...\""
show Carl with dis
c "\"{b}SATISFACTION, SATISFACTION{/b}.\""
"Carl says this in a robotic tone."
"He smiles, his eyes half-lidded. I groan."
...
c "\"... First of all, this is a TJ party we're talking about. Second, it's the middle of nowhere. Third, isn't Day of the Dead for like...\""
...
m "\"Alright, first, we can play your handheld if it turns out to be boring and religious.\""
"... though the idea of trying to come out to TJ amongst the fundy-Christian crowd is a nightmare."
...
"... which won't save us from sticking out like a sore thumb — including TJ."
show Carl Neutral with dis
...
c "\"I don't know. I guess I'm kinda curious. Worst case: we stop in, smack TJ around, and then make like Flynn's fetish and scat.\""
m "\"Best case: we stop in, smack TJ around, and they have food.\""
show Carl with dis
c "\"I'd rip your tail off for a cheese quesadilla right now.\""
m "\"Don't do that.\""
"I finally stow my phone in my pocket."
m "\"You think Flynn is actually into that sort of thing, or is it just a running joke?\""
m "\"I mean, you mention his cloaca or whatever near daily.\""
c "\"Dude, he's totally into that. I bet he's one of those septic suckers.\""
"Every fiber of my being does not want to know what that is. I give Carl a repulsed look."
c "\"I read about it on the image-boards. You know septic tanks, right?\""
m "\"Stop right there.\""
c "\"They drill holes in people's tanks while they aren't home and lower a rope down through—\""
m "\"Carl.\""
c "\"—and they climb down in. The solid-breaking stuff in the tanks makes everything super sticky, so they literally stick to the tank walls like a suction cup—\""
m "\"Jesus fucking Christ.\""
c "\"And then they take this chisel and use their tongue on the—\""
m "\"Carl, I'm going to beat your ass.\""
show Carl Neutral with dis
c "\"Honestly, it all sounds more favorable than going to a church party.\""
"Carl puts on a look of casual deadpan."
"Meanwhile, I'm trying not to gag up my macaroni salad from lunch."
m "\"I don't think it's a church thing.\""
c "\"Eh, yeah, neither do I.\""
show Carl with dis
c "\"Alright, I'll go with you.\""
...
"Growing up in a town with less than 60 people has made what looks like a conventional teenage experience on TV seem utterly foreign."
...
c "\"Meth?\""
m "\"Do you think TJ would go to a party where everyone smoked meth?\""
c "\"I don't think TJ would go to a party that didn't have a crucified Jesus statue watching over the attendees.\""
stop music fadeout 5.0
"I dip my paws into my pockets as we walk."
m "\"Meanwhile, Leo is out driving around with his new friends and going to actual Payton parties, probably.\""
c "\"Way I see it? Most people don't actually play football for the game in high school. It's all about like... the status.\""
if partner_choice == "Leo":
    m "\"I tried messaging him earlier because I wanted to... talk to him about something pretty big-like.\""
    m "\"He said he was busy and never got back to me.\""
    "Carl looks over, and I can see him canting his head curiously in my direction."
    m "\"Leo of the old days was so much different, like all big brother-like — dropping everything he was doing when we needed help.\""
    c "\"Well, would you do the same for him, dude?\""
    "I blink once, taking a second as I recall how selfish I'm sounding."
    "However, I nod."
    m "\"Yeah, of course.\""
    c "\"Sure.\""
    m "\"I'm serious.\""
    "Carl's lips thin along his muzzle and he merely nods ahead."
    c "\"Sure.\""
    "I grunt."
    c "\"What was the 'pretty big-like' thing that had you all... clenched about?\""
    "I exhale, shaking my head quickly."
    m "\"Nothing. Don't worry about it.\""
    c "\"Whatever you say, dude.\""
    "He shrugs, and we walk in silence for a few minutes."
elif partner_choice == "Other":
    "I grunt to the affirmative, biting my tongue for a moment before speaking."
...
"This does not look like a Christ Camp affair."
m "\"I don't see anyone outside here. Maybe everyone's inside?\""
"Carl shrugs."
c "\"Maybe.\""
c "\"We just got to get in and look for TJ's little, gray ass.\""
c "\"Or, y'know, his face. Any idea what we should say when we see him?\""
m "\"'Hi TJ', is a good start.\""
c "\"Okay, sounds good.\""
m "\"Cool.\""
"Neither of us moves."
...
d "\"Hi guys!\""
d "\"Oh, jeez, I'm sorry, Carl!\""
d "\"I didn't know I'd scare you that badly!\""
d "\"You shouldn't use those kinds of words though...\""
...
c "\"Real speciesist, dude.\""
show Carl Dejected with dis
m "\"What's up, TJ? Why are you dressed like a ghost?\""
t "\"My mom dropped me off about two minutes ago, but she had to go pick up something for Dad and left. I can't believe you guys walked here!\""
...
"Even under all that fabric, I can still picture TJ grinning cheerily. It's such a contrast to the past few hours with Carl."
"A contrast to this whole day, actually."
m "\"That's very considerate of your mother, TJ, but um... eh, never mind.\""
show Carl Annoyed with dis
c "\"How did {i}you{/i} get invited to this but not us?\""
show Carl Dejected with dis
"TJ cocks his ghostly head curiously to the side."
...
"I'm about to speak when TJ quickly interjects."
t "\"I... I thought I saw Leo here when my mom pulled up, actually.\""
t "\"He was by the parking lot with someone else, but when I got out I couldn't find him.\""
m "\"That's weird...\""
t "\"He didn't mention anything about going to this tonight, so it surprised me.\""
show Carl Annoyed with dis
c "\"Well, you didn't tell me about this either.\""
show Carl Dejected with dis
"I see TJ shift beneath his costume."
t "\"It was short notice, and I didn't think you'd have a costume or anything... or would want to come.\""
"The ram holds up the flats of his paws to the sheeted one."
c "\"It's fine, TJ. I get it.\""
...
t "\"I mean, it's okay to have a plus-one if Leo's here, right? But there are three of us.\""
...
c "\"Like, I'd assume people would want to come out for air, to smoke, and to make out.\""
...
"I don't feel nearly as confident without at least Leo with us."
...
"The scent of dust, drywall, and stray fiberglass insulation mixes with the more modern aromas of alcohol, perfume, and hot wax."
#! gel-matte? gel matte?
"Looking around, there are actually quite a few lit candles lying around, their flames contrasting with the colored gel matte halogen lighting."
...
"From the sniffling noises I hear beneath the costume, I can tell he's crying."
"A stumbling coyote girl nudges him with her foot before emptying the contents of her cup on his sheeted head."
#!! this could have a colon at the end instead?
...
"I hold up the flats of my paws to the de-hatted coyote."
...
#!! This or "stiff-leggedly"
"I step stiff-legged down the road a ways, reaching the bend where the vehicle sits."
...
"\"{cps=15}{font=ui/belligerent.ttf}Never have I ever killed someone.\""
window hide
...
window show
"My eyes wrench open."
"I'm being handled by something."
...
show Ghost TJ_Excited at center with dissolve
t "\"Chase!\""
"The pungent aroma of booze-soaked linen hits me before I can clearly make out who is in front of me."
"The lynx bumps his sheeted knuckles together, sniffling once."
m "\"... Hey TJ.\""
"I lower my paws, trying to get a sense of where I am."
...
"Out of all the questions I have, one pushes to the forefront."
m "\"Leo and Carl... where are they?\""
show Ghost TJ with dis
t "\"Leo brought you inside. He said he found you out on a dirt road a ways out.\""
"He fidgets for a moment."
t "\"That fox who was dragging me, I think he was intoxicated real bad-like.\""
t "\"When Leo found me with him, and the others around, he and the fox started arguing — lots of swearing and that sort of stuff.\""
t "\"Then he hit the fox guy, over and over, even when everyone else was telling him to stop.\""
t "\"There was blood and... gosh, I just want to go home.\""
"The lynx walks over toward the decrepit bed, staring at it some."
t "\"... I didn't know whether to let you rest on the mattress or not. I know you're not really a fan of spiders, and there were a few along the stitching.\""
"I feel my skin crawl at the mention, an involuntary shudder escaping from me."
"Funny how mention of 'septic-suckers' doesn't freak me out nearly as much as the damn eight-legged things."
m "\"Yeah, I'm uh... I'm good standing. Probably shouldn't be sleeping anyway.\""
t "\"Are you okay?\""
"TJ turns to face me, and I have to admit that there is something rather humorous about hearing such sincerity from a guy in a ghost costume."
m "\"I should be asking you that.\""
"He waves dismissively."
t "\"It's fine, I didn't even get punched or anything. I'm 13, I shouldn't... I shouldn't be such a baby anymore.\""
t "\"I curled up and cried in front of all these people, in front of Heather...\""
"It had been a frequent point of teasing from us to TJ that he liked her. She seemed like a really rough sort, but for some reason, they got along."
"From what TJ told me, they both used to be in the school's sports management club, but Heather had some family issues and had to drop out."
t "\"If I would have stood up for myself, or... just stood up in general... Leo wouldn't have had to hurt Heather's friend.\""
m "\"Look, Teej, he was a jerk. A drunk jerk. Out of all the things to beat yourself up over, that's not one.\""
"Even with his sheet, I can see TJ's eyes, and he doesn't seem convinced."
m "\"Where is Leo, by the way?\""
"He blinks."
t "\"I think he said he had to go take care of something real quick.\""
t "\"He told me he'd be back, though!\""
"TJ pauses, then straightens up with realization. He reaches beneath his costume and withdraws what looks like a mango."
"I stare at it for a good six seconds."
m "\"Okay, what is the relevance of this mango?\""
t "\"For eating! This guy Robert brought a whole bowl filled with fruit. I got it for you. It might make you feel better.\""
m "\"We're at a Day of the Dead party, doesn't anyone have... nachos or carne asada — something like that?\""
"The lynx shrinks back into himself some, rolling the mango in his paws."
t "\"No, I'm sorry. They only have fruit.\""
"I find myself gazing blankly at TJ and the mango. He steps up after a moment, placing the large fruit into my paws."
"I stand there, my head still hurting up a storm, holding a mango that a ghost has given me in an abandoned factory."
"A Day of the Dead mango, no less."
m "\"Thanks, TJ.\""
t "\"You're welcome, Chase. I feel responsible for having invited you to this when you were already feeling bad, and making things worse.\""
t "\"I just want to make it right, ya know?\""
t "\"Now, eheh...\""
"He takes a little step back, seeming to realize he's in my personal space."
t "\"What did you want to talk to me about?\""
"I rest my head in my paw, the other still brandishing the mango."
"I'm trying to figure out how to phrase this to someone like TJ."
"Jesus, here I go."
m "\"So, you know how when you go through puberty, you start liking girls and stuff right?\""
"There is a moment of hesitation from the sheeted figure, but I see fabric shuffle in a manner indicative of a nod."
m "\"When I went through puberty, I... {i}mainly{/i} started to see boys in the same way that people say a guy like me should see girls.\""
"The cat stares at me, and I see the expression of concern in his eyes shift to surprise."
t "\"Like being gay?\""
m "\"Yeah, that. You got it.\""
"I can't help but shift nervously, unsure of what to do with my hands or the mango."
"He does a little huff."
t "\"I know what that is, Chase, I'm not {i}that{/i} naive after growing up with you guys.\""
"It's really bothering me that I can't read his expression right now."
t "\"So do you like any boys in particular?\""
"I look to TJ, speechless. After the initial surprise, he seems completely unfazed."
t "\"I mean, you guys talk about each other's... you know... parts a lot. I didn't know if that was part of it, but I guess it might have been?\""
"I can practically feel the burning of TJ's cheeks from here. I quickly throw up my hands."
m "\"Whoa, no, that's just guy talk. I don't think the others in our group are gay. Like... what are even the chances of that?\""
"I decide to dodge his inquiry about who I like. That's... a whole 'nother kernel of corn, as my grandma used to say."
t "\"Probably not very high, but I don't really know much about that sort of thing.\""
m "\"Outside of what they tell you at church, you mean?\""
"I see TJ visibly recoil, then recombobulate."
t "\"That's not what our church is like.\""
t "\"I mean, if you went again, you'd know.\""
t "\"One of our youth pastors, Asha, is one of those biosensual types, even.\""
m "\"Bisexual.\""
show Ghost TJ_Excited with dis
t "\"Yeah, that!\""
show Ghost TJ with dis
t "\"She doesn't talk about it much. She's just, you know... normal. And you're normal, so that's good.\""
"I find myself smirking a bit. The way he's describing this to be reassuring in his usual, TJ-ish way is actually kind of cute."
t "\"Only God can really judge us for this sort of stuff, I think? People-judging can just be like an excuse to be mean.\""
t "\"I could... start reciting verses to you about it, but I doubt you'd like to hear that.\""
m "\"I'm alright.\""
"I pause."
m "\"Well, actually, no I'm not.\""
"TJ tilts his head. For some reason, his blue eyes flick toward the mango in my grasp."
m "\"I guess the problem is that my parents found out about me being like this in a really bad way that made a bad first impression, you know?\""
t "\"What happened?\""
"Again, I keep my tongue still, trying to go over in my head how best to put this. I wish I had practiced for this moment a little more."
m "\"I don't know if you should hear about this sort of stuff, TJ.\""
"He steps forward, closer. We're about a foot and a half apart now."
show Ghost TJ_Excited with dis
t "\"I'm not a baby! I want to help, please! It's the least I could do.\""
"I stare a little wide-eyed up at him, and he covers his face with his sheeted arms."
show Ghost TJ with dis
t "\"I'm sorry, Chase...\""
"I can hear the quivering in his voice. There's a strange amount of intensity from the lynx."
"I decide to just be blunt."
m "\"I got caught watching gay pornography on the computer this morning. That's how my parents found out.\""
t "\"What?\""
...
"TJ looks at me worriedly, straightening himself up."
l "\"Teej, your mom's here. You better get to her before she comes in.\""
t "\"Oh, er... okay! Thanks, Leo. Are you going to be okay?\""
"He nods, stepping over and patting the lynx's shoulder."
"I look down and notice that his knuckle-fur is matted with dried blood."
show Leo with dis
l "\"Don't worry about me, eh? S'you two little adventurous scamps that need to take care.\""
"He gives a little nod in my direction and I make what I think is a smile."
show Leo Neutral with dis
"Though judging by the wolf's concerned look, it didn't come out right."
hide Ghost with easeoutleft
"TJ quickly hustles his way outward, nearly running into a boar-fellow passing by."
"I can hear him apologizing profusely and the boar saying something about 'Casper needing to chill the fuck out'."
...
"There is a brief silence, and I feel his gaze still upon me."
...
m "\"He was.\""
#!!! This line reads a little weird during TJ's route.
#!!! In other routes Chase has just mentioned that Leo never told them about the party, but in TJ's route the last thing that's said is that Carl was at the party.
#!!! This line can probably be removed entirely from TJ's route
...
show Leo Neutral with dis
"I sigh, pulling up my phone."
window hide
show cellc 1 at center with easeinbottom
$ renpy.pause(100.0, hard=False)
play sound "texting1.ogg"
...
l "\"I was around the corner a few minutes ago. I overheard your little talk with Teej.\""
...
"I've known Leo since he didn't speak a lick of English, playing video games with me and Jasmynn after school."
...
l "\"... Fucking TJ? You drop this shit about you on him of all people?\""
show Leo Neutral with dis
...
"Not having much choice as I'm tugged like a rag doll, I comply, my mango falling to the wayside."
...
"We stop finally in front of one of the dark, back exits. There doesn't seem to be food, booze, or drugs in this part of the factory, so we're alone."
...
m "\"Why do you care so much that I told TJ and not you?\""
m "\"You didn't tell me about all {i}this{/i}.\""
l "\"So you're queer now, eh? I get that. Just, fuck, are you trying to put the moves on TJ now or something?\""
m "\"What the hell, I'm not trying to court him. I just needed somebody to talk to, okay?!\""
show Leo DarkAnnoyed with dis
l "\"What about Flynn? Are you and him a... ya know... thing?\""
"I stare at Leo, wide-eyed and gobsmacked."
m "\"Where are you getting that idea from? He's not gay.\""
...
l "\"I heard. That's real rough, yeah?\""
...
show Leo DarkNeutral at center with dis
l "\"Do you know how happy I was when I overheard you just now? It was like a fucking fantasy, you know?\""
show Leo DarkAnnoyed with dis
l "\"Then I started wondering why you didn't tell me, and then I got all mad and now I've ruined this.\""
show Leo DarkNeutral at center with dis
l "\"You went to innocent-ass TJ out of all people, and you didn't even know about the similar situation with Flynn or... me.\""
...
l "\"You are the fuckin' gold nugget in this turd-mine, yeah?\""
...
l "\"You made me happy when I was around ya before, but now it's like... I don't know, Otter, can't describe it well. Just a whole new type of happy.\""
l "\"Like, you know I fuckin' love you, but I {i}love{/i} you, ya know?\""
l "\"So, final point: you don't need to bother naive Teej with this sort of thing. You got me to talk to.\""
"My face starts to tingle, my heart thudding so loud in my chest, I'm sure Leo can hear it."
#! this could be a semicolon or etc after "happening"
...
"I feel completely awkward having left our talk where we did."
"It reminds me of the shock I laid on my parents, and I realize my earnest coming-out has now been shifted in his mind to my porn-deviancy."
"He's probably still blaming himself for everything, too."
...
"Leo begins to descend the stairway, keeping his paws hovering above the guardrail, just in case."
...
"The back lot of Parsons is mainly composed of old piles of dirt and some foundation, like they were planning on expanding before they shut down."
play music "Willows2.ogg" fadein 6.0
m "\"I'm not gonna corrupt TJ or fuck Flynn. You can ease up on the compliments.\""
...
"In the past, I had vocally lamented Leo's ascension to jockhood, especially his douchebag towny teammates."
l "\"Bah...\""
...
"In reality, I just didn't like the fact that he spent most of his after-school time at practice."
"I miss him."
...
"I make a circle with my fingers in a gesture of acknowledgment."
"I make sure there's no errant shrubbery around me before directing my muscles to lift my right leg as high up as it will go."
"It turns out, that's barely a 60-degree angle from its stationary position."
show Leo with dis
...
"I quietly mourn the absence of my mango as my stomach rumbles."
...
"A silence hangs between us. It's pretty obvious his mind has drifted to memories of Sydney. Mine as well."
#! this could be a semicolon or etc after "now"
...
"It's been about four years now, and it hasn't gotten any easier. Too many reminders here."
...
m "\"My therapist told me that I should talk about it more, but it isn't something that I can just... broach in between talk of football and video games.\""
...
"Mom and Dad haven't sent a text message in their lives, as far as I know, saying they prefer to talk as short text messages can lead to confusion."
"I do agree with them on that second bit."
stop music fadeout 10.0
show cellT 23 at center with easeinbottom
centered "_"
l "\"Who is it?\""
play sound "phonebuzz.ogg"
show cellT 24 at center
"I see Leo sort of crane his neck toward my phone, though he quickly recoils as I glance over at him."
l "\"Sorry...\""
m "\"S'aight. And it's from TJ. He's being religiously helpful.\""
hide cellT with easeoutbottom
"I manage a goofy smile, holding up the screen to Leo."
"He squints down at it for a moment, then exudes a low snerk, covering his forehead with his paw."
l "\"{i}Ay Madre{/i}, why can't they all be like Teej, eh?\""
m "\"{i}But who are we to judge?{/i}\""
"I put on a bit of a voice for that line. Leo groans, nudging me roughly."
m "\"If it wasn't for him, I wouldn't have even gone to the party and learned about you and Flynn being like me.\""
l "\"You think this is one of those 'fate' things?\""
"I shrug."
...
"Glancing over, I see that Leo seems genuinely happy now."
"I mean, a bit sweaty, fidgety, and blood-spattered — but so am I."
"I'm trying not to ruin it."
"I exhale and refocus, shifting my attention to the big ol' wolf currently holding my hand and looking at me expectantly."
...
l "\"Let's cut through here and head to my house through the rail yard.\""
...
"The Joshua trees and the old-timey pickup truck give it an out-of-place feeling."
...
l "\"Not if I find out you've been taking it, Otter. I'll shorten your lifespan real fuckin' quick.\""
...
"{b}{i}Keith & Brian's Booze Bastion{/i}{/b}."
play background "reststop.ogg"
...
"I haven't responded to TJ's text, but I think he'll understand."
play music "doublewalk.ogg" fadein 4.0
...
#!!! Chase remembers what Leo said incorrectly even though he's quoting it. Leo said "sack of furry stone". make the descriptions match together one way or the other, as the mismatch is very noticeable
"Despite being, as he puts it, a 'sack of furry stone', he has a lot more poise than yours truly."
...
"It comes to me, as if recited on a recorder in my brain, the short paragraph that I labored to memorize the night before my presentation:"
...
"I feel his head rub into mine, a neediness to his demeanor that I share."
...
"I got to hang out with him and play video games as a coping mechanism excuse."
...
l "\"And trust me...\""
"He raises up his large fist in front of me, showing the crimson that still stains his knuckle fur."
