...
#! reduces repetition of "place"
"It's a small place, but there are so many nooks and crannies in here that it could be in a million places."
...
#! "of" the stairs? Both are probably correct, but one is easier to read
"Sure enough, the ram suddenly comes swinging around the opening of the stairs."
...
#! reworded to reduce repetition of "stove"
"Carl looks into the metal stove before slapping the top of it."
show Carlalt2 with dis
c "\"Ha! There it is!\""
m "\"What? But how—\""
...
"It's a tight fit, but I'm skinny enough to make it."
...
"It's a lot older-looking than the photocopied newspaper that had burned up earlier."
show Raven with dis
...
"He holds it up to the candlelight."
...
#!!! It's odd that Chase is sprinting without much fuss here, since the rest of the route makes a big deal every time he's moving
...
"Jenna's not really moving now, and I slash at the rope uselessly for a moment before forcing myself to focus and start sawing at the rope."
"Carl seems to be hesitating at the door."
m "\"Carl!? Carl, help me!\""
...
#!! think "about" it? either is fine
"I don't really want to think about it, but it seems like he would have let Jenna die if I hadn't been there."
...
#!!! Jenna starting a sentence with "besides" twice in a row is clunky, even though the lines between might distract most readers from noticing
j "\"If he's not fighting it, why should I?\""
...
#!! "something" repeated is a bit clunky
...
#!!! The first sentence with the semicolon needs a rework.
m "\"So when I was doing research, I learned they both got convicted of sodomy. John was hanged and James left to start his ice cream business.\""
...
show Carlalt2 Neutral at left with dissolve
c "\"Hm.\""
"Carl lets out what could be a grunt next to me."
m "\"What do you think—\""
...
m "\"Carl?\""
"He doesn't look up."
#!!!! This line (Carl, we need to keep moving) should probably be removed. It's likely a leftover from the other route
...
"I just barely catch a glimpse of Jenna and Raven moving toward the mansion, Jenna leaning on the husky for support."
...
show Carlalt2 Neutral with dis
#!! Need to confirm how this sentence is intended to read
"I reach out and grab Carl's arm, at which point he freezes and finally looks at me."
...
"It envelops almost the entire thing and I gasp out in surprise, almost groaning at how sensitive I am."
...
m "\"What was that?\""
c "\"You came.\""
"Carl is sitting up now, dumping one of the several pillows behind us from its pillowcase."
m "\"You bit my ear.\""
...
#!! "the overalls, a white shirt" is a little weird. Fixed a little
"I have enough time to see overalls and a white shirt, before suddenly he turns and vanishes into the dark."
...
#!!! repeating "the stairs" twice in row is awkward
"Swallowing again, I force myself forward, toward the stairs and finally down them."
...
"I hear clopping at the bottom, along with voices — small childlike voices."
...
"I'm at the door to the crawl space, and without hesitation I unlatch the door and throw it open—"
...
#!!! repeated "the stairs", maybe switch to: practically falling down "them" into the basement below
"I feel my heart sink as I limp and jump to the stairs, practically falling down them into the basement below."
scene bg basement with dissolve
...
"Plastic bins, I think, like what Carl has in his crawl space."
"Is that where I am?"
...
"The ceiling is way too high to be the crawl space as well."
...
#!! either "sounds"+"stop" or "sound"+"stops"
"The sound of shifting bins stops, and I hear the clopping coming closer to me."
c "\"You awake, boy?\""
...
#!!! Is "you are" and "does not" intentional? It doesn't seem like James has a trend of not using contractions?
c "\"I know you're awake, but it doesn't matter now.\""
...
"This isn't Carl anymore, but I guess I already knew that."
m "\"I...what happened?\""
...
"Then he tips the container he's holding upside down, and I see a long nozzle, light shining through the translucent neck."
...
"I'm in the crawl space, the massive beams are gone, the ceiling is lower, there's no more mine."
...
"I back away into the basement, out of the crawl space, ducking low as smoke billows over me."
"It looks like Carl's coming after me, but just as he reaches out..."
"Little tiny paws grasp around his waist, his chest, and his face, pulling him back into the crawl space."
...
"I get weak, my lungs screaming in the smoky air, feeling my limbs start to give out—"
"And then something gives, but it's Carl."
"The hands pull through him, and something large and transparent gets pulled out."
"It flies back with a howl, and Carl flies forward into me, the door closing with a snap."
stop music fadeout 5.0
...
"His eyes are blank and faraway."
#! maybe?
"I reach up to touch his face, to say thanks somehow."
