...
"The smells of the desert, sagebrush, and dirt overwhelm my senses."
"Everything is black around me, but there are a million stars above me."
#! A few ways to tweak this
"I hear the smattering of small feet running circles around my body and the snuffling of noses up against my sides and neck."
...
"Where am I?"
"The last thing I remember is the lake."
...
#!!! maybe "as my ankle rolls" to reduce repetition of "and"
"It happens on weak ankles, though, and my right foot gives out as my ankle rolls."
...
#!! not a fan of "right on our left" as they're both directions
...
"Carl shifts me to the wall so I can lean against it, then tries the doorknob."
...
#!!! Carl is not wearing a sweatshirt at this point in time
"He comes up with a bunch of wooden splinters clinging to his head fur, beard, and shirt."
show Carlalt Surprised at center with dissolve
c "\"Nothing.\""
...
#! reduces "here" repetition
m "\"I think the bigger issue is that we're here at all. I mean, where the hell is here?\""
...
m "\"Carl, are you sure this isn't some extension of your house? Maybe something that leads out of the crawl space?\""
...
m "\"Raven and I remember going to the crawl space, then losing consciousness after we found that hole, which is where you went, Carl.\""
show Carlalt Rejected with dis
...
"I remember taking an overnight job back when I was a freshman and how that had fucked up my sleeping schedule."
...
show Carlalt Neutral with dis
#!!! Maybe make it more obvious that carl is bending forward to give Chase a piggy-back ride
#!!! It's unclear what exact positioning Carl is in, which means the following "butt sex joke" bit is very difficult to figure out
#!!! Cutting the "butt sex joke" bit is probably a good idea anyway
"Carl hunches forward in front of me."
...
#! reduces repeating "paired with". Other options available
"That paired with his grin and him holding a knife is slightly disconcerting."
...
stop music fadeout 3.0
#!! "therefore" -> "so"? therefore is not a common word for chase to use
"This room has no illumination, so we have to rely on the light from the hallway to see inside."
...
#! reduces repetition of "mine"
"He turns his head towards me, touching his cheek to mine."
...
"Raven jiggles the handle a few times and Carl tries to look into the cracks between the logs, but it's completely black."
...
"Staring at it a few seconds longer allows me to make out the clear shape of horns under a bedsheet..."
...
"But then maybe he was just sleepwalking? I remember him doing that when he slept over at my house years ago."
...
"The shaking is so wild that the sheet starts to slip off of the head, as if whatever is under the sheet is trying to shake it off."
...
#!! Maybe?
"Carl moves closer to me, starting to look through the various decorums of the dining room."
m "\"Like what?\""
...
m "\"How is clearing James Hendricks's name going to end...this?\""
...
c "\"What else do we have to go off of?\""
...
c "\"Isn't that the guy that—Whoa!\""
show Carlalt Surprised with dis
...
"At that moment, a great moaning sound shakes the walls, almost knocking me off my feet and sending plates crashing to the floor."
...
"Just as I'm starting to give in, something grabs the scruff of my neck hard and yanks me up so violently that my teeth clack together."
...
"It definitely looks like it came from one of the bins in the crawl space—"
