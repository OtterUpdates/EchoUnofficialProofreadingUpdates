...
m "\"Did they try his landline? Maybe he just muted his phone. He sleeps in like, every day.\""
"Jenna shrugs."
...
"He mutters absentmindedly as we head out the door."
...
stop music fadeout 5.0
"We walk in silence for the first few minutes, looking at the rolling hills and mountains, cactus, and sagebrush."
...
"I step on a particularly sharp rock and bite my lip to keep from yelping."
...
"While the brush has mostly grown back, scorched earth and black sagebrush skeletons still remain."
stop music fadeout 5.0
...
m "\"But if I have a heat stroke, it's all on you.\""
...
"We follow the old coyote around the side of the house, weaving through sagebrush and tumbleweeds."
...
#! probably?
"I sigh, deciding whether or not I'm actually gonna leave TJ and come back when it's not so hot."
...
m "\"No!\""
"I'm suddenly very conscious of everything around me, all the little twigs and branches of the sagebrush looking like spiders."
m "\"Are you sure!?\""
t "\"Yes!\""
...
#!! Could also be ellipses I guess?
...
#!! "I learned" -> "I've learned"? or maybe "learned -> learn"? Most variations work to some extent
m "\"I mean, I forget everything I've learned within a week.\""
...
#!!! maybe restructure this so there's not two "ands" in a row without punctuation
...
"In one hand is a broom and in the other is a plate of what probably used to be cookies."
...
#!!! "it's" a bit soggy on the surface? "is" is fine if it's meant to be emphasized
"I pick up a cookie and take a bite. It's a bit soggy on the surface, but it's warm and gooey in the center."
m "\"Mmmmh.\""
...
#! Too many "ands" in a row without punctuation; this is maybe okay now?
"He grunts as he pulls me, and that's when my stomach lurches and I roll over to vomit up the cookies."
t "\"Crap...crap!\""
