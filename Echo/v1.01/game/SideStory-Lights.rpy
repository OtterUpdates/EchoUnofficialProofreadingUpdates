...
"I reach the refreshments table and ladle more juice into my cup, sighing to myself."
...
#!!!! Does Leo have a truck at this point in time? He normally has a van. Many references to a truck in this short story
...
if not renpy.music.is_playing(channel="sound"):
    play sound "trailsteps.ogg"
"I head over to the truck, passing under the street lamps. The lights are dim and the lot is mostly dark, including the space Leo's truck is occupying."
...
"I start backpedaling as the driver's side door opens, and I'm about to turn and run when the headlight comes on and Leo leans out."
...
"Leo shoots a quick glare at Chase before turning to me."
show Leo with dis
...
"It's completely dark, and I look up. It seems I've walked past the street lights on this road."
...
#!! Not sure if TJ is supposed to be inhaling or exhaling here, but originally the two parts of the sentence did not match
"I exhale, the night air pierced by the sound of my breath being released."
...
"I consider running and hiding in there, but there's no guarantee the doors are unlocked, or worse yet, maybe that's where the person who's following me lives."
...
"I make it under another street light, and then another. I pass under another two before I make it in front of the dilapidated house."
...
#!! Gendering the thing as "his" without any clues is sort of jarring here. Once TJ sees the figure it's fine
"I can hear its ragged breathing coming from my right and moving to the left, just outside of the light."
#!! Gendering the thing as "his" without any clues is sort of jarring here. Once TJ sees the figure it's fine
"I shift on my feet, and I can hear its footsteps echoing in the darkness."
t "{i}\"Hello?!\"{/i}"
show shade5 onlayer screens:
    ease 10 alpha 0.6
...
t "\"Carl?!\""
show Carl with dis
"Carl nods in a manner that says \"the one and only\", and he pulls a — cigarette? — out of his mouth."
...
play sound "cardoorsecondhalf.ogg"
#! A period works fine here, but it could be changed in other ways too
...
#!! "misshaped" -> "misshapen"? Both are fine, but for some reason I was expecting to read misshapen here.
"I blink a few times to clear my eyes, and I can blurrily see the silhouette of a lanky, misshapen person standing just outside of the light."
"But we pull too far away for me to make anything out clearly."
#!! Too many repetitions of "and" and "back". Fixed it partially
"I turn back around and lean my head back into the headrest as I close my eyes, feeling them well up with tears."
