...
#!!! probably change to "into the blackness, feeling my throat close up" to remove one of the "and"s
"I whip my head up and stare into the blackness, feeling my throat close up."
c "\"{cps=10}Please...\""
"I say it to no one, but everyone at the same time."
"It comes out strangled and whiny because I'm about to start crying."
...
$ vol("sound", 0.5)
#!!!! What does this line do? It doesn't seem to have any effect ingame? I read with instant text so maybe that has something to do with it
...
"" "{i}{b}\"State your destination.\"{/b}{/i}"
c "\"{cps=25}Home!\""
"I almost sob it out, leaning back in the seat and covering my face, sighing with relief."
"" "{i}{b}\"Navigating to Pueblo. You should reach your destination in three hours and thirty-two minutes.\"{/b}{/i}"
"My eyes fly open."
c "\"NO!\""
...
"" "{b}{i}\"Navigating to The University of Pueblo.\"{/i}{/b}"
c "\"No!\""
"" "{b}{i}\"You should reach your destination in three hours and thirty-nine minutes.\"{/i}{/b}"
c "\"NO!\""
"I slam my fist into the console."
#!!! 4th line wrap. Consider breaking into two dialogue boxes?
...
"" "{cps=20}{font=ui/COLONNA.ttf}{i}\"You have arrived; your destination is on your left.\"{/i}"
$ reset_channel("music")
...
"" "{b}{i}\"Navigating home. You should reach your destination in three minutes.\"{/i}{/b}"
...
"I put the car in drive and pull into the road, driving to where the GPS is telling me to go."
...
#!! to remove the repeated "spots"
"On that white are little dark red spots that keep popping up in different positions."
...
"I couldn't look, at the time, but I know he's lying in a bloody heap in the passenger-side footwell."
...
"Once I get to the back door I shove my paws into my pockets, but there aren't any keys because I left them in the ignition."
"I sob again and look around desperately."
"The longer I hold still the deeper I sink into the ground."
"Again, I almost give in, but then I see the tree house."
