...
j "\"We're trying to find our way out of here and screwing around isn't going to help.\""
...
#!!! these 3 lines (scene, show, with dissolve) don't seem necessary and cause a short pause
# scene bg cabin3
# show nightoverlay
# with dissolve
...
"My shirt is damp and I look down to see two wet spots where his eyes had been."
...
ra "\"Chaase!\""
#!! is the stove in the fireplace? If not, this should probably be fireplace -> stove
...
"Not at all like the clearly photocopied newspaper we'd seen earlier."
...
"I crawl over to their writhing bodies, one eye wincing shut as each movement sends a lightning bolt through my leg."
...
show Carlalt2 Rejected with dis
"Carl chuckles before letting out another, softer groan."
...
m "\"Yeah.\""
"It seems that at this point Jenna isn't really Jenna anymore."
...
c "\"No rush. I'm actually starting to feel the same way.\""
...
#! Capitalization after ellipses is sort of subjective but this one seems like an easy decap
m "\"Uhh...yeah.\""
...
"Which I realize is exactly what we're doing when we walk straight into what feels like sagebrush."
...
c "\"The desert, right?\""
#!! Maybe drop "so"? This reads a bit oddly in context of the conversation
...
"Over our ragged breathing, though, there's dead silence all around us...except for a drumbeat."
...
"—that black shadow creature contorting and bending through the sagebrush that Carl was having so much trouble moving through."
...
"My voice raises in pitch as I look back behind us, the black shape now discernible in the firelight as it slithers around the rocks and sagebrush."
...
#!! maybe nose -> muzzle to reduce repetition of "my nose"
"The smell hits me like a wave and I immediately gag, doubling over and pressing a hand to my nose before pulling up the neck of my shirt over my muzzle."
...
stop music fadeout 5.0
"At the same time, I'm fearfully eyeing the opening, terrified of what I'm about to see."
...
#!!! the second part of this sentence is awkward. maybe "one hand rubbing at her neck" or a pause somewhere
"She's already sitting up herself, one hand rubbing at her neck."
m "\"Are you okay?\""
play music "quiet.ogg" fadein 5.0
"I reach out to her."
...
m "\"Thank you, Carl. I don't know what I would have done if you hadn't shown up.\""
...
j "\"Besides, isn't this about clearing James's name, or whatever? Why are we talking about John?\""
...
#!!! "with her mouth open" should probably have some sort of separation from the rest of the sentence, or rework it. I made an attempt but it's not amazing
"She looks confused, but her mouth is open like she wants to say something."
m "\"Jenna?\""
...
"So it's not as simple as just \"clearing James's name\"."
...
#!! "on his back" is redundant and repeats "back"
"Carl's laying back down on the floor, staring up at the ceiling again."
...
#!!! Sam doesn't normally talk in \" quotes. These are the only instances of Sam talking with \" quotes (when not directly associated with a speaking character)
#!!! (is this supposed to be Sam?)
...
ra "\"Where are we?\""
c "\"My parents' room...\""
"Carl's voice is hushed, quiet, as if afraid that if he speaks too loudly this will all disappear."
...
c "\"What the hell?\""
#!! onto the railing?
"Carl almost whines out the words as I see him grip tightly onto the railing."
...
"I turn around, finding her eyeing me suspiciously."
...
m "\"I think so?\""
show Carlalt2 Depressed with dis
"The look of utter...defeat(?) on Carl's face has me hesitating to confirm it."
c "\"What the fuck...\""
...
"I look down, over the side, onto the rocky, sagebrush-covered slope."
"And there's Jenna."
...
c "\"No, Chase.\""
#!!! something bad literally always happens when they're getting the pieces of paper lol. Kind of a weird thing for Chase to think
...
#!!! "me too" makes no sense in the conversation. This line feels like it's replying to a sentence that didn't happen
c "\"Yeah, but you sort of just fell back. Sorry, I dropped you and I think you hit your head.\""
...
m "\"According to Hendricks's research, James may have been in a romantic relationship with a Native fox by the name of John Begay.\""
...
#!! For readability, otherwise it can initially read like these are adjectives for his eyes
"Carl's stuttering and stumbling, eyes wide with terror."
...
menu:
    ...
    "Push Jenna.":
        ...
        stop music fadeout 5.0
        show Carlalt2 Surprised at center with dissolve
        "I think we're heading toward the mansion again, but Carl turns us toward the road to the town instead."
...
"Carl doesn't respond, and I look over to see him looking straight ahead, eyes fixed on nothing."
m "\"Carl?\""
...
"We're further down the road now to the point where I can't hear Jenna or Raven anymore."
...
"How are we even going to be near each other now?"
...
"Instead I feel little pointed bits of rock sticking into my foot pads, even though there's smooth pavement when I look down at the ground."
...
"Carl smirks at me."
c "\"I want to go to college, but I wanna get an art degree. Then I just wanna get some job I can halfway stand and play games in my free time.\""
...
c "\"Sounds cliché, huh? But it's true.\""
...
"In fact, the whole table is covered in dust that probably came from the crawl space."
...
#!!! this line is really awkwardly placed. Chase jabs him a couple lines above, and he reacts only now.
#!!! I think all 3 lines need to be reworked in order to avoid this.
"He jumps."
show Carlalt2 Surprised at center behind nightoverlay with dissolve
...
"The voice is calm and reasonable, and I'm pretty sure it's Raven's."
...
#!! Are the other letter reading segments in italics? Should they be?
...
"I don't have James's letters, so I have no idea what John was responding to."
...
"...Is Jenna in the crawl space right now, searching for letters?"
...
"I get up and limp to the doorway again, looking out toward the crawl space."
stop music fadeout 5.0
scene bg basement with dissolve
"In that moment, I hear a whisper of movement down the hall."
...
"She's covered in the dust from the crawl space."
...
"I need to give Carl or I a chance to attack from behind, depending on if she goes for me or takes a turn into the weight room."
m "\"She's coming!\""
...
"While I could try to go for a bathroom and lock the door, that doesn't exactly help out Carl."
"I can't stop thinking about the newspaper clipping that John's hanging corpse ate."
...
"I can hear Carl shouting, too, at the base of the stairs."
...
#! "that's" enough for John? or maybe "it's" enough?
"It's only a few seconds, but that's enough for John to gain on me and swing with the knife again as I pull open the door."
...
#!!! Maybe reword to prevent saying "it" twice, e.g. "clinging to the trunk"
"I stumble right into it, clinging to the trunk."
...
#!!! John needs a character for white dialogue text, or just give this line to Jenna
"\"YOU!!!\""
...
m "\"'But I was able to open a lockbox kept by James himself. It was full of jail letters between him and John'.\""
...
"Several Native children went missing, James was accused of the crime before claiming that his secret lover, John, was the culprit."
...
"We all did."
#!! This should probably be "Except Carl. He seemed", or with an emdash or something
...
"Carl told me that he didn't know where he ended and James began, even when he rejected James's influence."
...
screen credits_text():
    ...
    frame at credits_scroll(320.0):
        ...
        vbox:
            ...
            vbox:
                label " " text_style "cred3_text"
                text "\"Echo (Remix of Look Forwards)\" lillybug"
