...
ra "\"If the interview was based on looks alone he'd have that job locked!\""
m "\"Yeah, probably.\""
...
m "\"Shit.\""
"I dash back to the car and open the passenger door so I can get to the glovebox."
...
"He glances at me and his eyes are red - for once, it's not because of weed."
...
"I don't need to get out of the car to gauge the mood my friends are in; their shoulders slumped, faces turned away from each other."
...
"I think about the time I used to come down to this spot every day and skip rocks with Jenna and TJ."
...
"It is, of course, a bad idea to fall asleep underwater."
...
#!!!! Also, this music is notably louder than other music in Echo
play music "Vanishing_Paradise.ogg" fadein 5.0
...
#!! This sentence may need a rework. "chasing" and "grab/throw" don't agree.
"Despite my aching head I turn around and see Flynn chasing TJ, grabbing and throwing him down onto the rocks."
#!! force "that" they fly?
"Flynn doesn't get any further, though, because Leo tackles him with such force that they fly a good five feet before smashing down into the rocks and sand."
...
"Except Jenna."
#! there are a few ways to tweak this
"She watches us as we pull out and keeps watching until we're out of sight."
stop music fadeout 10.0
...
c "\"I don't know.\""
m "\"You don't—\""
#!!!! Maybe something can be changed to emphasize this is a coyote "person" and not a wild animal?
#!!!! Even after being in the Echo headspace it's nearly impossible for me to think of anything other than a wild coyote here
...
"I watch as she tears out into the sagebrush, zigzagging about, arms flinging out in all directions."
...
"He's not in the basement, either, but I can see the yellow light glowing from the crawl space."
...
"I stumble down into the crawl space and, again, Carl's not there."
