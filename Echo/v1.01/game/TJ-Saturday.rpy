...
#!! past tense probably? otherwise everything in this sentence needs to be present tense
"It took him a good twenty minutes to get ready, and all the while I struggled not to glare at him."
...
"TJ still holds my paw as Julian, Jenna, and Carl stand next to us, the five of us in a sort of semicircle around the boulder."
...
m "\"The dirt...it looks like someone dug it up recently.\""
...
#! "between the rocks" probably? was something else intended?
"I grab the back of TJ's shirt just as I see Carl's hoof disappear between the rocks."
...
#!!!! They didn't play spin the bottle. need to change it to either "Never have I ever" or "Ten Fingers" etc
t "\"I don't...I still don't know if he did it. But then I remembered what he said when we played Ten Fingers ...I felt like it had to be him.\""
...
"I shrug."
#! removed repeated "now"
m "\"Well, like I said yesterday, I think now that he knows he isn't going to get the answers he wants, he's just out to hurt us. That's it, really.\""
...
#!! "try to talk" -> "trying to talk"/"to try to talk" or something similar?
...
"I grab his arm."
#! probably?
"He swings, trying to yank it back, and I shove him back toward his truck."
m "\"Leave.\""
...
t "\"I haven't been there for like, ten years. That could be a lot of fun.\""
...
"I realize how good it feels to sort of envelop him like this."
...
#!!! Is the jack supposed to be an intentional reference to their killing of Samuel?
#!!! It feels like going through that experience would prevent her from ever forgetting a jack again?
#!!! is Janice stupid, chat?
...
#!!!! Flynn explicitly doesn't go to the diner right?
ja "\"Well, that grumpy lizard, Flynn, was telling me about it a few days back.\""
ja "\"Somethin' about you wanting to document the spooky stuff in town.\""
m "\"Ah...\""
"I try to think of a way to keep things uninteresting so she doesn't ask any more questions."
...
"Janice pauses and glances at me, and I make sure not to give her anything, staring glassy-eyed at my notepad."
t "\"What did it say?\""
...
ja "\"In the podcast they were goin' on about how places with lots of quartz end up bein' more haunted. Ya know why?\""
...
#! probably? just a little clearer that it's the bottle that isn't there, not the table
"Then he picks up a bottle that isn't there from the table and takes a swig from it."
...
m "\"Sydney?\""
"There's a raspy, rustling sound, and I see the thing in the mirror shake, its head twitching from side to side, far too fast to be anything of this world."
"I take a step back."
...
#! It's odd to start this with ellipses, since in practice with the special font it just starts the text with a weird indent
...
"As I continue to stare at the small, disfigured creature, I get the feeling that it's starting to move independently from me."
...
"I feel sick."
#!! some comma restructuring done, but I think it reads well enough now
...
#!! comma slightly improved this, but this might need more restructuring
...
#!!!! Jasmynn? Since they're in a dream-flashback
...
"Empty."
"I park and shut off the engine, jumping out and jogging toward the faint trail through the sagebrush."
...
#!!! Assuming there should be three periods between "happen" and "on", otherwise the spacing is slightly odd in-game
"{font=ui/forbid.ttf}It...seems to happen...on its own..."
m "\"Then what the hell is this?\""
#!!!! Chase ripping the paper here is probably not a good idea, since it's already been torn in half at least once from when he was digging it up
#!!!! probably drop this detail
...
"His big, strong hands find my neck and start to squeeze."
...
f "\"What?\""
"I watch blood drip to the flat rock in a steady rhythm from my nose, having to breathe extra hard through my mouth because of it."
...
play music "this lingering hope.ogg"
...
scene bg lakesunset with dissolve
"By the time we get to our feet, it's dark and I have to help the lynx along through the sagebrush."
...
scene bg echoroadsunset with dissolve
"I watch it disappear in the rearview mirror, sitting alone under the yellow parking lot light."
...
"It's not a pleasant walk, the trail almost obscured by sagebrush and dry vegetation."
hide Devon
hide Cameron
with dissolve
